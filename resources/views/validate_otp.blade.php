                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-center">
                        <div class="card shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
                            <!-- Form -->
                            <form class="row g-3" method="post" action="{{ ('/verify_otp_num') }}">
                            ...
                            @csrf
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <input type="otp" class="form-control form-control-lg" name="otp">
                                    </div>
                                </div>
                                 @error('otp')
                        ...
                        @enderror
                                <div class="col-12 text-center mt-4">
                                    ...
                                    <button type="submit"  class="btn btn-lg btn-block btn-dark lift text-uppercase">VERIFY</button>
