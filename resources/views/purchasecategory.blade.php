                ...
                <div class="row g-2 row-deck"> 
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            @endif
                            <div class="card-body">
                                <table id="purchasecategorys" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th width="5%">#</th>
                                    ...
                                    <div class="modal-body custom_scroll">
                                        <div class="row g-4">
                                            ...
                                            <div class="col-sm-6 text-end">
                                                <label class="form-label">Category Name (Arabic)<span class="red">*</span></label> 
                                                <input type="text" dir="rtl" class="form-control form-control-lg" id="arabiccategoryname" name="arabiccategoryname" >
                                                <div class="alert-danger pt-1 pb-1 px-1 py-1" id="categorynamealertar" style="display:none ;">Please enter category name</div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="modal-body custom_scroll">
                                        <div class="row g-4">
                                            ...
                                            <div class="col-sm-6 text-end">
                                                ...
                                                <div class="alert-danger pt-1 pb-1 px-1 py-1" id="categorynameeditalertar" style="display:none ;">Please enter category name</div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
                ...
                <!-- PROFILE TEST LISTING STARTS HERE -->
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            <div class="card-body">
                                <table id="purchasesubcategorys" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                    <thead>
                                        <tr>
                                        	<th width="5%">#</th>
                        ...
                        <div class="modal fade" id="add-sub-category" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="col-sm-6 text-end">
                                        <label class="form-label">Sub Category Name (Arabic) <span class="red">*</span></label>
                                        <input type="text" dir="rtl" class="form-control form-control-lg" id="arabicsubcategoryname" name="arabicsubcategoryname">  
                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="subcategorynamealertar" style="display:none ;">Please enter subcategory name</div>                                                                              
                    ...
                    @csrf 
                        <div class="modal fade" id="edit-subsample-type" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Edit Item Sub Category</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body custom_scroll">
                                        <div class="row g-4">
                                            ...
                                            <div class="col-sm-6 text-end">
                                                ...
                                                <div class="alert-danger pt-1 pb-1 px-1 py-1" id="subcategorynameeditalertar" style="display:none ;">Please enter subcategory name</div>                                                                             
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal-footer">
...
<script type="text/javascript">
    ...
    document.getElementById('categorynamealertar').style.display = 'none';
     ...
     if(document.addcategory.arabiccategoryname.value == ''){
        document.getElementById('categorynamealertar').style.display = 'block'; 
        document.addcategory.arabiccategoryname.focus();  
        return false;
     }
...
function formeditValidation()
{
    ...
    document.getElementById('categorynameeditalertar').style.display = 'none';
     ...
     if(document.editcategory.arabiccategorynameedit.value == ''){
        document.getElementById('categorynameeditalertar').style.display = 'block'; 
        document.editcategory.arabiccategorynameedit.focus();  
        return false;
     }
...
return true;
 ...
 function formsubcategoryValidation(){
    ...
    document.getElementById('subcategorynamealert').style.display = 'none';
        document.getElementById('subcategorynamealertar').style.display = 'none';
    if(document.addsubcategory.categoryid.value == ''){
     ...
     if(document.addsubcategory.subcategoryname.value == ''){
      ...
      if(document.addsubcategory.arabicsubcategoryname.value == ''){
        document.getElementById('subcategorynamealertar').style.display = 'block'; 
        document.addsubcategory.arabicsubcategoryname.focus();  
        return false;
     }
...
document.getElementById('subcategorynameeditalertar').style.display = 'none';
...
else if(document.editsubcategory.arabicsubcategorynameedit.value == ''){
    document.getElementById('subcategorynameeditalertar').style.display = 'block'; 
    document.editsubcategory.arabicsubcategorynameedit.focus();  
    return false; 
}
...
<script>
$(document).ready(function() {
    $('#purchasesubcategorys').DataTable({
        "order": [], // Disable initial sorting on page load
        "lengthMenu": [10, 25, 50, 75, 100], // Customize the number of records shown per page
        "language": {
            "paginate": {
