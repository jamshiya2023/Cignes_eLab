...
<form class="row g-3" id="addparameter" name="addparameter" method="post" action="{{ route('parameter.edit') }}">                            
@csrf 
<div id="parameterdiv">
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header" style="padding-bottom:0px;">
                                            <h6 class="card-title m-0">Update Parameter</h6>
                                        ...
                                        <div class="card-body">                                      	
                                            ...
                                            <div class="row g-4">
                                                <div class="col-sm-6">
                                                    ...
                                                    <input type="text" class="form-control form-control-lg" name="parametername" id="parametername" placeholder="Enter here" value="{{$parameters->parameter_name}}">
                                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="parameternamealert" style="display:none ;">Please enter parameter name</div>
                                                </div>
                                                <div class="col-sm-6 text-end">
                                                    <label class="form-label">Parameter Name (Arabic)<span class="red">*</span></label>
                                                    <input type="text" dir="rtl" class="form-control form-control-lg" name="arabicparametername" id="arabicparametername"  value="{{$parameters->parameter_name_arabic}}">
                                                <div class="alert-danger pt-1 pb-1 px-1 py-1" id="parameternamealertar" style="display:none ;">Please enter parameter name</div>

                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="form-label">Short Code</label>
                                                    <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="parametershortcode" id="parametershortcode" value="{{$parameters->short_code}}">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="form-label">LIS Parameter Code</label>
                                                    <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="parameterliscode" id="parameterliscode" value="{{$parameters->lis_parameter_code}}">
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="form-label">Label / Heading</label><br />
                                                    <input type="radio" class="form-check-input" name="labelheading" value="yes" {{ ($parameters->label_heading == 'yes') ? 'checked':''}}> 
                                                    <label for="finalresult">Yes</label>
                                                    <input type="radio" class="form-check-input" name="labelheading" value="no" {{ ($parameters->label_heading == 'no') ? 'checked':''}}> 
                                                    <label for="finalresult">No</label>
                                                </div>
                                                
                                                <div class="col-sm-6">
                                                    <label class="form-label mb-3">Final Result</label><br />
                                                    <input type="radio" class="form-check-input" name="finalresult" value="yes" {{ ($parameters->final_result == 'yes') ? 'checked':''}}> 
                                                    <label for="finalresult">Yes</label>
                                                    <input type="radio" class="form-check-input" name="finalresult" value="no" {{ ($parameters->final_result == 'no') ? 'checked':''}}> 
                                                    <label for="finalresult">No</label>
                                                </div>
                                            ...
                                            <div class="row g-4">
                                                <div class="col-sm-6">
                                                    ...
                                                    <select name="equipment" id="equipment" placeholder="-- Please Select --">
                                                        ...
                                                        <option value="{{ $equipment->machineid }}" {{ ($parameters->equipment_id == $equipment->machineid) ? 'selected':''}}>{{ $equipment->machine_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
                                                <div class="col-sm-6">
                                                    <label class="form-label">Equipment Test ID</label>
                                                    <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="equipmenttestid" id="equipmenttestid" value="{{ $parameters->equipment_test_id }}">
                                                </div>
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <select class="form-select form-select-lg" name="resultvalue" id="resultvalue">
                                                        <option value="">-- Please Select --</option>
                                                        <option value="alphabets" {{ ($parameters->result_value == 'alphabets') ? 'selected':''}}>Alphabets</option>
                                                        <option value="numbers" {{ ($parameters->result_value == 'numbers') ? 'selected':''}}>Numbers</option>
                                                    </select>
                                                </div>
                                                <div class="col-sm-3">
                                                    <label class="form-label">Duration</label>
                                                    <input type="text" class="form-control form-control-lg" placeholder="Enter duration in hours" name="duration" id="duration" value="{{ $parameters->duration }}">
                                                </div>
                                                <div class="col-sm-6">
                                                ...
                                                <div class="col-sm-6">
                                                    ...
                                                    <select name="parametermethod" id="parametermethod" placeholder="-- Please Select --">
                                                        ...
                                                        <option value="{{ $method->testmethodid }}" {{ ($parameters->method_id == $method->testmethodid) ? 'selected':''}} >{{ $method->testmethod }}</option>
                                                        @endforeach
                                                    </select>
                                                ...
                                                <div class="col-sm-3">
                                                    ...
                                                    <select class="form-select form-select-lg" name="decimalnos" id="decimalnos" >
                                                        <option value="">-- Please Select --</option>
                                                        <option value="1" {{ ($parameters->decimal_nos == '1') ? 'selected':''}}>1</option>
                                                        <option value="2" {{ ($parameters->decimal_nos == '2') ? 'selected':''}}>2</option>
                                                        <option value="3" {{ ($parameters->decimal_nos == '3') ? 'selected':''}}>3</option>
                                                        <option value="4" {{ ($parameters->decimal_nos == '4') ? 'selected':''}}>4</option>
                                                    </select>
                                                </div>
                                                <div class="col-sm-3">
                                                    ...
                                                    <select name="parameterunit" id="parameterunit" placeholder="-- Please Select --">
                                                        ...
                                                        <option value="{{ $unit->unitid }}" {{ ($parameters->unit_id == $unit->unitid) ? 'selected':''}}>{{ $unit->labunit_name }}</option>
                                                        @endforeach
                                                    </select>
                                                </div>
...
<table class="table table-bordered mt-3" id="tblreferencelist">
  <thead>
  <tr>
  <th colspan="6" class="text-center">Age Limit</th>
  <th colspan="9" class="text-center">Normal Value</th>
  ...
  <tbody>   
   @foreach ($referenceranges as $ranges)
   <tr>
        <td colspan="3" class="text-center" valign="middle">{{$ranges->lowertype}} {{$ranges->lowervalue}} {{$ranges->lowerchronological}}</td>
        <td colspan="3" class="text-center" valign="middle">{{$ranges->highertype}} {{$ranges->highervalue}} {{$ranges->higherchronological}}</td>
        <td colspan="2" class="text-center" valign="middle">{{$ranges->malevalue}}</td>
        <td valign="middle" class="text-center">{{$ranges->minmalevalue}}</td>
        <td valign="middle" class="text-center">{{$ranges->maxmalevalue}}</td>
        <td colspan="2" class="text-center" valign="middle">{{$ranges->femalevalue}}</td>
        <td class="text-center" valign="middle">{{$ranges->minfemalevalue}}</td>
        <td class="text-center" valign="middle">{{$ranges->maxfemalevalue}}</td>
        <td class="text-center"><a style="cursor:pointer" class="btn btn-link btn-sm text-danger" onclick="removetrash({{$ranges->refid}},this)"><i class="fa fa-trash"></i></a></td>
    </tr>
   @endforeach
  </tbody>
</table> 
                                        ...
                                        <div class="card-footer text-end">
                                            <input type="hidden" name="parameterid" value="{{ $parameters->id }}">
                                            <input type="hidden" name="mappingid" value="{{ $parameters->pemid }}">
...
function next() {
    document.getElementById('parameternamealert').style.display = 'none';
        document.getElementById('parameternamealertar').style.display = 'none'; 
    ...
    if(document.addparameter.parametername.value == ''){
	 ...
	 if(document.addparameter.arabicparametername.value == ''){
		document.getElementById('parameternamealertar').style.display = 'block'; 
		document.addparameter.arabicparametername.focus(); 
        return false;
	}
...
function removetrash(id,trid){
    //alert(id+' '+trid);
    //return false;
    var tokendel = $('input[name="_token"]').val();
