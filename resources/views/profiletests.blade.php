                ...
                <div class="row g-2 row-deck">
                    ...
                    <div class="col-xl-12">
                        <div class="card">
                                        ...
                                        <tr>
                                            ...
                                            <a href="{{'update-profiletest/'.$profile->id}}" class="btn btn-link btn-sm text-secondry" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" aria-label="Edit">
                                             ...
                                             <?php if($profile->status =='1') { ?> 
                                                <a href="{{ 'block-profiletest/'.$profile->id }}"  onclick="return confirm('Do you want to block this profiletest?')" class="btn btn-link btn-sm text-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Active" aria-label="Active">
                                                    <i class="fa fa-ban" style="color:#198754;"></i>
                                                    
                                                </a>
                                                <?php } else { ?>
                                                    <a href="{{ 'unblock-profiletest/'.$profile->id }}" onclick="return confirm('Do you want to unblock this profiletest?')" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Blocked" aria-label="Blocked">
                            ...
                            <!-- Modal -->
<div class="modal fade" id="profiletests" tabindex="-1" data-bs-backdrop="static">
