                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">{{ $monthname}} {{ $day }}, {{ $year }} {{$recepttime[0]}}:{{$recepttime[1]}} {{strtolower($timeformat[1])}}</td>
                                              <td>
                                              @if(isset($data->firstname) && isset($data->lname))
                                                    {{$data->firstname}} {{$data->lname}}
                                                  @else
                                                   Admin
                                                  @endif
                                              </td>
                                            <td>{{$data->samplerej}}</td>
        ...
        success: function(response){
          ...
          var monthname;
            ...
            $.each(response.testlists, function( index, tests ) {
                ...
                if(tests.fname == null || tests.fname == undefined || tests.fname == '0'){
               rej_name = 'Super Admin';
                } else {
                    rej_name = tests.fname.concat(' ', tests.lname);   
                }
                console.log(rej_name);
                testlist += '<tr><td class="text-center" style="width:5%">'+num+'</td><td class="text-first" style="width:15%">'+tests.testname+'</td><td class="text-first" style="width:15%">'+rej_name+'</td><td style="width:15%" class="text-first">'+rejreasonhtml+'</td><td style="width:50%" class="text-first">'+rejnotehtml+'</td></tr>';
