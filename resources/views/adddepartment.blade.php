                        ...
                        <div class="card" >
                            ...
                            <div class="card-body">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-3" id="hidden_divv" style="display:none;" >
                                        <label class="form-label">Department Name (Arabic) <span class='red'>*</span></label>
                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="departmentar">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="designationar">
...
function formValidation() 
{
    ...
    else if(document.getElementById('hidden_div').style.display == 'block' && document.adddepartment.departmentar.value == '') {
        document.getElementById('departmentalertar').style.display = 'block';  
        document.adddepartment.departmentar.focus();
        return false;     
    }else if(document.adddepartment.designationar.value == ''){
        document.getElementById('designationalertar').style.display = 'block'; 
        document.adddepartment.designationar.focus(); 
        return false;      
    }
