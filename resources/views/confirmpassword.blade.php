                ...
                <div class="row">
                    <div class="col-lg-6 d-none d-lg-flex justify-content-center align-items-center">
                        <div style="max-width: 30rem;">
                            ...
                            <div class="mb-5">
                                <h2 class="color-900">eLab Application</h2>
                            </div>
                            <!-- List Checked -->
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-center">
                        <div class="card shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
                            <!-- Form -->
                                    ...
                                    <form class="row g-3" id="changepassword" name="changepassword" method="post" action="{{'/confirm-password' }}">                        
                            @csrf
                        ...
                        <p>3. Contain at least one special character (in this case, one of @$!%*#?&)are at least 8 characters long</p>
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        ...
                                        <input type="password" class="form-control form-control-lg @error('newpass') is-invalid @enderror" id="newpass"   name="newpass">
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="newpassalert" style="display:none ;">Please enter new password</div>
                                     @error('newpass')
                        ...
                        @enderror
                                    ...
                                    <div class="mb-2">
                                        ...
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="confirmpassalert" style="display:none ;">Please enter confirm password</div>
                                     @error('password')
                            <span class="invalid-feedback" role="alert">
                                <strong>{{ $message }}</strong>
                            </span>
 ...
 @error('confirmpass')
                        ...
                        @enderror
                                ...
                                <div class="col-12 text-center mt-4">
                                    <!-- <a href="#" title="" class="btn btn-lg btn-block btn-dark lift text-uppercase" >SUBMIT</a> -->
                                     @if(Session::has('user_id'))
                                    <input type="hidden" id="userid" name="userid" value="{{ Session::get('user_id') }}">
                                    <input type="hidden" id="foremail" name="foremail" value="{{ Session::get('email') }}">
                                         @endif
                                   <a style="cursor:pointer;" class="btn btn-lg btn-block btn-dark lift text-uppercase" onclick="return formValidation();">Submit</a>
                                </div>
...
{
    document.getElementById('newpassalert').style.display = 'none'; 
    document.getElementById('confirmpassalert').style.display = 'none'; 
    if(document.changepassword.newpass.value == ''){
        document.getElementById('newpassalert').style.display = 'block'; 
        document.changepassword.newpass.focus();  
        return false;     
    } else if(document.changepassword.password.value == ''){
        document.getElementById('confirmpassalert').style.display = 'block'; 
        document.changepassword.password.focus();  
        return false;     
    } else if(document.changepassword.newpass.value != document.changepassword.password.value){
        document.getElementById('confirmpassalert').style.display = 'block';
        document.getElementById('confirmpassalert').innerHTML = 'Both passwords mismatch';
