...
<div class="page-body px-xl-4 px-sm-2 px-0 py-lg-2 py-1 mt-3">
            <div class="container-fluid" style="min-height:450px;" >
                <div class="row">
                    ...
                    <div class="row g-4" >
                    <form class="row g-3" id="addtax" name="addtax" method="post" action="{{ route('tax.add') }}">                            
                    @csrf
                    <div class="col-lg-12 col-md-12 col-sm-12" >
                        <div class="card" >
                            <div class="card-header">
                                <h6 class="card-title mb-0">Add Tax</h6>
                            </div>
                            <div class="card-body">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="taxname">
                                     ...
                                     <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="taxnamear">
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="taxnamealertar" style="display:none ;">Please enter tax name</div>
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="form-label">Rate <span class='red'>*</span></label>
                                        <input type="number" class="form-control form-control-lg" name="taxrate">
...
function formValidation() 
{
    ...
    if(document.addtax.taxname.value == ''){
        ...
        document.getElementById('taxnamealertar').style.display = 'block'; 
