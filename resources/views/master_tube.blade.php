        ...
        <div class="page-body px-xl-4 px-sm-2 px-0 py-lg-2 py-1 mt-3">
            <div class="container-fluid"> 
                ...
                <!-- SINGLE TUBE STARTS HERE -->
                    <div class="col-xl-12">
                        ...
                        <div class="card">
                            ...
                            <div class="card-header">
                                <h6 class="card-title m-0">Tubes</h6> <a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-tube">Add Tube</a>
                            ...
                            @if(\Session::get('success'))
                                ...
                                @endif
                            <div class="card-body">
                                <table id="tbltube" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th style="width:5%">#</th>
                                            <th style="width:30%">Tube</th>
                                            <th style="width:30%">Tube (Arabic)</th>
                                            <th style="width:20%">Tube Code</th>
                                    ...
                                    @php if($tube->tube_serial_no != '') {
                                        $tubeno = $tube->tube_serial_no;
                                    } else { 
                                        $tubeno ="-NA-";
                                    }
                                    @endphp
                                        <tr>
                                            ...
                                            <td>
                                            @php if($tube->tube_name_arabic) { $arabicname = $tube->tube_name_arabic; } else {$arabicname = '-NA-';} @endphp     
                                            {{$arabicname}}</td>
                                            <td>{{$tubeno}}</td>
                                           
                                            <td class="text-center">
                                            <a  onclick="editview('{{$tube->id }}');"class="btn btn-link btn-sm text-secondry" data-bs-toggle="modal" data-bs-target="#edit-tube{{ $tube->id }}"> 
                                                    <i class="fa fa-edit" style="color:#555CB8;"></i>
                                                </a>
                                                    
                                             @php if($tube->status == '1') { @endphp
                                                <a href="{{ 'block-tube/'.$tube->id }}" onclick="return confirm('Do you want to block this tube?')" class="btn btn-link btn-sm text-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Active" aria-label="Active">
                                                <i class="fa fa-ban" style="color:#198754;"></i>
                                             </a>

                                             @php } else { @endphp
                                                <a href="{{ 'unblock-tube/'.$tube->id }}" onclick="return confirm('Do you want to unblock this tube?')" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Blocked" aria-label="Blocked">
                    ...
                    <!-- SINGLE tube LISTING ENDS HERE -->
  <!-- ADD tube POPUP STARTS HERE -->
                                   
                 <form class="row g-3" id="addtube" name="addtube" method="post" action="{{ route('tube.add') }}">                              
                @csrf 
                        <div class="modal fade" id="add-tube" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                <div class="modal-content">
                                    <div class="modal-header">
                                        <h5 class="modal-title">Add Tube</h5>
                                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                    </div>
                                    <div class="modal-body custom_scroll">
                                    <div class="row g-4">
                                    <div class="col-sm-6">
                                        <label class="form-label">Tube Name <span class="red">*</span></label>                                        
                                        <input type="text" class="form-control form-control-lg" name="tubename" id="tubename" >  
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="tubenamealert" style="display:none ;">Please enter tube name</div>                                      
                                    </div>

                                    <div class="col-sm-6 text-end">
                                        <label class="form-label">Tube Name (Arabic) <span class="red">*</span></label>                                        
                                        <input type="text" dir="rtl" class="form-control form-control-lg" name="arabictubename" id="arabictubename" >  
                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="tubenamealertar" style="display:none ;">Please enter tube name</div>                                      

                                    </div>

                                    <div class="col-sm-12">
                                        <label class="form-label">Tube Code</label>                                        
                                        <input type="text" class="form-control form-control-lg" name="tubeno" id="tubeno" >  
...
<form class="row g-3" id="edittube" name="edittube"  method="post" action="{{ route('tube.edit') }}" >                             
                @csrf 
               
   
                    <div class="modal fade" id="edit-tube-type" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-lg modal-dialog-scrollable">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <h5 class="modal-title">Edit Tube</h5>
                                ...
                                <div class="modal-body custom_scroll">
                                    <div class="row g-4">
                                        <div class="col-sm-6">
                                            <label class="form-label">Tube Name <span class="red">*</span></label> 
                                            <input type="text" class="form-control form-control-lg" id="tubenameedit" name="tubenameedit" >                                            
                                            <div class="alert-danger pt-1 pb-1 px-1 py-1" id="tubenameeditalert" style="display:none ;">Please enter tube name</div>                                        
                                        </div>
                                        <div class="col-sm-6 text-end">
                                        <label class="form-label">Tube Name (Arabic)<span class="red">*</span></label>                                        
                                        <input type="text" dir="rtl" class="form-control form-control-lg" name="arabictubenameedit" id="arabictubenameedit" > 
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="tubenameeditalertar" style="display:none ;">Please enter tube name</div>                                        

                                    </div>
                                        <div class="col-sm-12">
                                        <label class="form-label">Tube Code</label>                                        
                                        <input type="text" class="form-control form-control-lg" name="tubenoedit" id="tubenoedit" >  
                                ...
                                <ul class="list-group list-group-flush list-group-custom custom_scroll mb-0" style="height: 300px;">
                                    ...
                                    <li class="list-group-item py-3">
                                        <div class="d-flex align-items-center">
                                            ...
                                            <div class="flex-fill ms-3 text-truncate">
                                                <p class="mb-0 color-800">tube Photography</p>
...
<script type="text/javascript">
    $(document).ready(function () {
        $('#add-tube,#edit-tube-type').modal({
            backdrop: 'static',
            keyboard: false
        })
   });
    $('#edit-modal-close-x,#edit-modal-close').click(function(){
        $('#tubenamealertedit').hide();
        $('#edit-tube-type').modal('hide');
    });
        // ADD tube FORM VALIDATION STARTS HERE
    function formValidation()
    {
    document.getElementById('tubenamealert').style.display = 'none';
     document.getElementById('tubenamealertar').style.display = 'none';
     if(document.addtube.tubename.value == ''){
        document.getElementById('tubenamealert').style.display = 'block'; 
        document.addtube.tubename.focus();  
        return false;
     }
     if(document.addtube.arabictubename.value == ''){
        document.getElementById('tubenamealertar').style.display = 'block'; 
        document.addtube.arabictubename.focus();  
        return false;
     }
     document.addtube.submit();    
return true;
...
success:function(response){
    $('#tubenameedit').val(response.tube_name);
    $('#arabictubenameedit').val(response.tube_name_arabic);
    $('#tubenoedit').val(response.tube_serial_no);
    $('#hiddenid').val(response.id);
    $('#edit-tube-type').modal('show');
    }
});
...
function formeditValidation()
{
    ...
    document.getElementById('tubenameeditalert').style.display = 'none';
     document.getElementById('tubenameeditalertar').style.display = 'none';
     if(document.edittube.tubenameedit.value == ''){
        document.getElementById('tubenameeditalert').style.display = 'block'; 
        document.edittube.tubenameedit.focus();  
        return false;
     }
      if(document.edittube.arabictubenameedit.value == ''){
        document.getElementById('tubenameeditalertar').style.display = 'block'; 
        document.edittube.arabictubenameedit.focus();  
        return false;
     }
     document.edittube.submit();    
return true;
};
