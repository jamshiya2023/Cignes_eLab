    ...
    <div class="container-fluid" style="min-height:450px;" >
        <div class="row">
            ...
            <div class="row g-4" >
                    ...
                    <form class="row g-3" id="adddepartment" name="adddepartment" method="post" action="{{ url('edit-department/'.$designation->id) }}"> 
                         @csrf
                        <div class="col-lg-12 col-md-12 col-sm-12" >
                            <div class="card" >
                                <div class="card-header">
                                    <h6 class="card-title mb-0">Update Designation</h6>
                                </div>
                                <div class="card-body">
                                    <div class="row g-4">

                                    
                                        <div class="col-sm-3" id="hidden_div">
                                            <label class="form-label">Department Name <span class='red'>*</span></label>
                                            <input type="text" class="form-control form-control-lg" name="department" value="{{$designation->department_name}}">
                                            <div class="alert-danger pt-1 pb-1 px-1 py-1" id="departmentalert" style="display:none ;">Please enter department</div>
                                        </div>
                                         <div class="col-sm-3" id="hidden_div">
                                            <label class="form-label">Department Name(Arabic) <span class='red'>*</span></label>
                                            <input type="text" class="form-control form-control-lg" name="departmentar" value="{{$designation->department_namear}}">
                                            <div class="alert-danger pt-1 pb-1 px-1 py-1" id="departmentalertar" style="display:none ;">Please enter department</div>
                                        </div>
                                        <div class="col-sm-3">
                                            <label class="form-label">Designation <span class='red'>*</span></label>
                                            <input type="text" class="form-control form-control-lg" name="designation" value="{{$designation->designation_name}}">
                                            <div class="alert-danger pt-1 pb-1 px-1 py-1" id="designationalert" style="display:none ;">Please enter designation</div>
                                        </div>
                                        <div class="col-sm-3">
                                            <label class="form-label">Designation(Arabic) <span class='red'>*</span></label>
                                            <input type="text" class="form-control form-control-lg" name="designationar" value="{{$designation->designation_namear}}">
                                            <div class="alert-danger pt-1 pb-1 px-1 py-1" id="designationalertar" style="display:none ;">Please enter designation</div>
                                        </div>
...
document.getElementById('newdepart').addEventListener('change', function () {
    ...
    document.getElementById('hidden_div').style.display = style;
     document.getElementById('hidden_divv').style.display = style;
});
...
function formValidation() 
{
    ...
    if(document.adddepartment.designation.value == ''){
        document.getElementById('designationalert').style.display = 'block';  
        return false;      
    }
  document.getElementById('designationalertar').style.display = 'none';   
    if(document.adddepartment.designationar.value == ''){
        document.getElementById('designationalertar').style.display = 'block';  
        return false;      
    }
    
     document.getElementById('departmentalert').style.display = 'none';   
    if(document.adddepartment.department.value == ''){
        document.getElementById('departmentalert').style.display = 'block';  
        return false;      
    }
  document.getElementById('departmentalertar').style.display = 'none';   
    if(document.adddepartment.departmentar.value == ''){
