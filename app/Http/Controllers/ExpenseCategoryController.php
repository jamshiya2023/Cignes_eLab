...
class ExpenseCategoryController extends Controller
{
    public function expensecategoryview()
    {
        if(Auth::check()){
            $userId = Auth::id();
            $expensecategorys = ExpenseCategory::select('id','expensecategory','status','expensecategoryar')
            ->orderBy('id','desc')
            ->get();
    ...
    public function expensecategoryadd(Request $request)
    {
        if(Auth::check()){
            ...
            $expensecategory->expensecategory = $request->input('expensecategoryname');
             $expensecategory->expensecategoryar = $request->input('expensecategorynamear');
    ...
    {         
       ...
       $expensecategory = ExpenseCategory::where('id',$id)
                ->select('id','expensecategory','expensecategoryar')
                ->first();
    ...
    { 
        ...
        $expensecategory->expensecategoryar = $request->input('expensecategorynameeditar');
