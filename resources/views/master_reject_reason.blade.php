...
<style>
            ...
            <div class="container-fluid">
                <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h6 class="card-title m-0">Reject Reason</h6><a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-sample-type">Add Reject Reason</a>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="rejectreason" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th style="width:3%">#</th>
                                                        <th style="width:45%">Reject Reason</th>
                                                        <th style="width:45%">Reject Reason (Arabic)</th>
                                                        <th style="width:7%"class="text-center">Actions</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                @foreach($rejectreasons as $key => $value)
                                                    <tr>
                                                        <td>{{ ++$key }}</td>
                                                        <td>{{ $value->rejectreason }}</td>
                                                        <td>{{ $value->rejectreason_arabic }}</td>
                                                        <td class="text-center">
                                                            ...
                                                            <a href="{{ 'block-reject-reason/'.$value->id }}"  onclick="return confirm('Do you want to block this reject reason?')" class="btn btn-link btn-sm text-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Active" aria-label="Active">
                                                                <i class="fa fa-ban" style="color:#198754;"></i>                                                                
                                                            </a>
                                                            <?php } else { ?>
                                                                <a href="{{ 'unblock-reject-reason/'.$value->id }}" onclick="return confirm('Do you want to unblock this reject reason?')" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Blocked" aria-label="Blocked">
                    ...
                    @endforeach
                            ...
                            <form class="row g-3" id="addrejectreason" name="addrejectreason" method="post" action="{{ url('reject-reasons') }}">                            
                                @csrf
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Reject Reason <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="rejectreasonname" id="rejectreasonname" >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="rejectreasonnamealert" style="display:none ;">Please enter reject reason </div>                                                
                                                    </div> 
                                                    
                                                    <div class="col-sm-6 text-end">
                                                        <label class="form-label">Reject Reason (Arabic) <span class="red">*</span></label>
                                                        <input type="text" dir="rtl" class="form-control form-control-lg" name="arabicrejectreasonname" id="arabicrejectreasonname" >
                                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="rejectreasonnamealertar" style="display:none ;">Please enter reject reason </div>                                                

                                                    </div> 
                                                </div>                                
                                            </div>
                                            <div class="modal-footer">
                                                <a class="btn btn-primary" onclick="addrejectreasonValidation();">Save</a>
                            ...
                            <form class="row g-3" name="editrejectreason" method="post" action="{{ route('rejectreason.edit') }}">                            
                                @csrf
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Reject Reason <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="rejectreasonnameedit" id="rejectreasonnameedit" >
                                                        <input type="hidden" class="form-control form-control-lg" name="hiddenid" id="hiddenid"  >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="rejectreasonnamealertedit" style="display:none ;">Please enter reject reason </div>                                                
                                                    </div>  
                                                    
                                                    <div class="col-sm-6 text-end">
                                                        <label class="form-label">Reject Reason (Arabic)<span class="red">*</span></label>
                                                        <input type="text" dir="rtl" class="form-control form-control-lg" name="arabicrejectreasonnameedit" id="arabicrejectreasonnameedit" >
                                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="rejectreasonnamealerteditar" style="display:none ;">Please enter reject reason </div>                                                
                                            ...
                                            <div class="modal-footer">
                                                <a class="btn btn-primary" onclick="editrejectreasonValidation();">Save</a>
    ...
    $('#add-modal-close-x, #add-modal-close').click(function() {
        ...
        $('#arabicrejectreasonname').val('');
        $('#rejectreasonnamealert').hide();
        $('#add-sample-type').modal('hide');
    });

    $('#edit-modal-close-x, #edit-modal-close').click(function() {
        $('#rejectreasonnamealertedit').hide();
        $('#edit-sample-type').modal('hide');
    });

   
    function addrejectreasonValidation() {
        document.getElementById('rejectreasonnamealert').style.display = 'none';
         document.getElementById('rejectreasonnamealertar').style.display = 'none';
        if(document.addrejectreason.rejectreasonname.value == ''){
            document.getElementById('rejectreasonnamealert').style.display = 'block';  
            document.addrejectreason.rejectreasonname.focus(); 
            return false;     
        }
         if(document.addrejectreason.arabicrejectreasonname.value == ''){
            document.getElementById('rejectreasonnamealertar').style.display = 'block';  
            document.addrejectreason.arabicrejectreasonname.focus(); 
            return false;     
        }
    document.addrejectreason.submit();
    return true;
    }
    ...
    function editview(id){
        ...
        $.ajax({
            ...
            success: function(response){
                $('#rejectreasonnameedit').val(response.rejectreason);
                $('#arabicrejectreasonnameedit').val(response.rejectreason_arabic);
    ...
    function editrejectreasonValidation() {
        if(document.editrejectreason.rejectreasonnameedit.value == ''){
            document.getElementById('rejectreasonnamealertedit').style.display = 'block';  
            document.editrejectreason.rejectreasonnameedit.focus(); 
            return false;     
        }
         if(document.editrejectreason.arabicrejectreasonnameedit.value == ''){
            document.getElementById('rejectreasonnamealerteditar').style.display = 'block';  
            document.editrejectreason.arabicrejectreasonnameedit.focus(); 
            return false;     
        }
    document.editrejectreason.submit();
    return true;
    }
    </script>
