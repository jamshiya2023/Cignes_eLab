...
<style>
            ...
            <div class="container-fluid">
                <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h6 class="card-title m-0">Expense Category</h6><a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-sample-type">Add Expense Category</a>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="expensenew" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th style="width:3%">#</th>
                                                        <th style="width:90%">Expense Category</th>
                                                        <th style="width:90%">Expense Category(Arabic)</th>
                                                        <th style="width:7%"class="text-center">Actions</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                @foreach($expensecategorys as $key => $value)
                                                    <tr>
                                                        <td>{{ ++$key }}</td>
                                                        <td>{{ $value->expensecategory }}</td>
                                                         <td>{{ $value->expensecategoryar }}</td>
                                                        <td class="text-center">
                                                            ...
                                                            <a href="{{ 'block-expense-category/'.$value->id }}"  onclick="return confirm('Do you want to block this expense category?')" class="btn btn-link btn-sm text-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Active" aria-label="Active">
                                                                <i class="fa fa-ban" style="color:#198754;"></i>                                                                
                                                            </a>
                                                            <?php } else { ?>
                                                                <a href="{{ 'unblock-expense-category/'.$value->id }}" onclick="return confirm('Do you want to unblock this expense category?')" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Blocked" aria-label="Blocked">
                    ...
                    @endforeach
                            ...
                            <form class="row g-3" id="addexpensecategory" name="addexpensecategory" method="post" action="{{ route('expensecategory.add') }}">                            
                                @csrf
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="expensecategoryname" id="expensecategoryname" >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="expensecategorynamealert" style="display:none ;">Please enter expense category </div>                                                
                                                    </div>  
                                                    
                                                     <div class="col-sm-6">
                                                        <label class="form-label">Expense Category(Arabic) <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="expensecategorynamear" id="expensecategorynamear" >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="expensecategorynamealertar" style="display:none ;">الرجاء إدخال فئة المصاريف </div>                                                
                                                    </div>  
                                                </div>                                
                                            </div>
                                            <div class="modal-footer">
                                                <a class="btn btn-primary" onclick="addexpensecategoryValidation();">Save</a>
                            ...
                            <form class="row g-3" name="editexpensecategory" method="post" action="{{ route('expensecategory.edit') }}">                            
                                @csrf
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Expense Category <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="expensecategorynameedit" id="expensecategorynameedit" >
                                                        <input type="hidden" class="form-control form-control-lg">
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="expensecategorynamealertedit" style="display:none ;">Please enter expense category </div>                                                
                                                    </div>   
                                                     <div class="col-sm-6">
                                                        <label class="form-label">Expense Category(Arabic) <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="expensecategorynameeditar" id="expensecategorynameeditar" >
                                                        <input type="hidden" class="form-control form-control-lg">
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="expensecategorynamealerteditar" style="display:none ;">Please enter expense category </div>                                                
                                                    </div>  
                                                </div>                                
                                            </div>
                                            <div class="modal-footer">
                                             <input type="hidden" class="form-control form-control-lg" id="hiddenid" name="hiddenid" >
                                                ...
                                                <a class="btn btn-primary" onclick="editexpensecategoryValidation();">Save</a>
    ...
    $('#add-modal-close-x, #add-modal-close').click(function() {
        ...
        $('#expensecategorynamealert').hide();
        $('#add-sample-type').modal('hide');
    });

    $('#edit-modal-close-x, #edit-modal-close').click(function() {
        $('#expensecategorynamealertedit').hide();
        $('#edit-sample-type').modal('hide');
    });

   
    function addexpensecategoryValidation() {
        document.getElementById('expensecategorynamealert').style.display = 'none';
         document.getElementById('expensecategorynamealertar').style.display = 'none';
        if(document.addexpensecategory.expensecategoryname.value == ''){
            document.getElementById('expensecategorynamealert').style.display = 'block';  
            document.addexpensecategory.expensecategoryname.focus(); 
            return false;     
        }
        if(document.addexpensecategory.expensecategorynamear.value == ''){
            document.getElementById('expensecategorynamealertar').style.display = 'block';  
            document.addexpensecategory.expensecategorynamear.focus(); 
            return false;     
        }
    document.addexpensecategory.submit();
    return true;
    }
    ...
    function editview(id){
        ...
        $.ajax({
            ...
            success: function(response){
                $('#expensecategorynameedit').val(response.expensecategory);
                 $('#expensecategorynameeditar').val(response.expensecategoryar);
    ...
    function editexpensecategoryValidation() {
        if(document.editexpensecategory.expensecategorynameedit.value == ''){
            document.getElementById('expensecategorynamealertedit').style.display = 'block';  
            document.editexpensecategory.expensecategorynameedit.focus(); 
            return false;     
        }
        if(document.editexpensecategory.expensecategorynameeditar.value == ''){
            document.getElementById('expensecategorynamealerteditar').style.display = 'block';  
            document.editexpensecategory.expensecategorynameeditar.focus(); 
            return false;     
        }
    document.editexpensecategory.submit();
    return true;
    }
    </script>
