...
<style>
            ...
            <div class="container-fluid">
                <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h6 class="card-title m-0">Income Category</h6><a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-sample-type">Add Income Category</a>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="incomenew" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th style="width:3%">#</th>
                                                        <th style="width:90%">Income Category</th>
                                                         <th style="width:90%">Income Category(Arabic)</th>
                                                        <th style="width:7%"class="text-center">Actions</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                @foreach($incomecategorys as $key => $value)
                                                    <tr>
                                                        <td>{{ ++$key }}</td>
                                                        <td>{{ $value->incomecategory }}</td>
                                                         <td>{{ $value->incomecategoryar }}</td>
                                                        <td class="text-center">
                                                            ...
                                                            <a href="{{ 'block-income-category/'.$value->id }}"  onclick="return confirm('Do you want to block this income category?')" class="btn btn-link btn-sm text-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Active" aria-label="Active">
                                                                <i class="fa fa-ban" style="color:#198754;"></i>                                                                
                                                            </a>
                                                            <?php } else { ?>
                                                                <a href="{{ 'unblock-income-category/'.$value->id }}" onclick="return confirm('Do you want to unblock this income category?')" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Blocked" aria-label="Blocked">
                    ...
                    @endforeach
                            ...
                            <form class="row g-3" id="addincomecategory" name="addincomecategory" method="post" action="{{ route('incomecategory.add') }}">                            
                                @csrf
                                    ...
                                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Income Category <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="incomecategoryname" id="incomecategoryname">
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="incomecategorynamealert" style="display:none;">Please enter income category</div>
                                                    </div>
                                                    
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Income Category (Arabic) <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="incomecategorynamear" id="incomecategorynamear">
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="incomecategorynamealertar" style="display:none;">Please enter income category</div>
                                                    </div>

                                                </div>                                
                                            </div>
                                            <div class="modal-footer">
                                                <a class="btn btn-primary" onclick="addincomecategoryValidation();">Save</a>
                            ...
                            <form class="row g-3" name="editincomecategory" method="post" action="{{ route('incomecategory.edit') }}">                            
                                @csrf
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Income Category <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="incomecategorynameedit" id="incomecategorynameedit" >
                                                        <input type="hidden" class="form-control form-control-lg">
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="incomecategorynamealertedit" style="display:none ;">Please enter income category </div>                                                
                                                    </div>  
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Income Category(Arabic) <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="incomecategorynameeditar" id="incomecategorynameeditar" >
                                                        <input type="hidden" class="form-control form-control-lg">
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="incomecategorynamealerteditar" style="display:none ;">Please enter income category </div>                                                
                                                    </div> 
                                                </div>                                
                                            </div>
                                            <div class="modal-footer">
                                                <input type="hidden" class="form-control form-control-lg" id="hiddenid" name="hiddenid" >
                                                <a class="btn btn-primary" onclick="editincomecategoryValidation();">Save</a>
    ...
    $('#add-modal-close-x, #add-modal-close').click(function() {
        ...
        $('#incomecategorynamealert').hide();
        $('#add-sample-type').modal('hide');
    });

    $('#edit-modal-close-x, #edit-modal-close').click(function() {
        $('#incomecategorynamealertedit').hide();
        $('#edit-sample-type').modal('hide');
    });

  
    function addincomecategoryValidation() {
        document.getElementById('incomecategorynamealert').style.display = 'none';
        document.getElementById('incomecategorynamealertar').style.display = 'none';

        if (document.addincomecategory.incomecategoryname.value == '') {
            document.getElementById('incomecategorynamealert').style.display = 'block';
            document.addincomecategory.incomecategoryname.focus();
            return false;
        }

        if (document.addincomecategory.incomecategorynamear.value == '') {
            document.getElementById('incomecategorynamealertar').style.display = 'block';
            document.addincomecategory.incomecategorynamear.focus();
            return false;
        }

        document.addincomecategory.submit();
        return true;
    }
    ...
    function editview(id){
        ...
        $.ajax({
            ...
            success: function(response){
                $('#incomecategorynameedit').val(response.incomecategory);
                 $('#incomecategorynameeditar').val(response.incomecategoryar);
    ...
    function editincomecategoryValidation() {
        if(document.editincomecategory.incomecategorynameedit.value == ''){
            document.getElementById('incomecategorynamealertedit').style.display = 'block';  
            document.editincomecategory.incomecategorynameedit.focus(); 
            return false;     
        }
         if(document.editincomecategory.incomecategorynameeditar.value == ''){
            document.getElementById('incomecategorynamealerteditar').style.display = 'block';  
            document.editincomecategory.incomecategorynameeditar.focus(); 
            return false;     
        }
    document.editincomecategory.submit();
    return true;
    }
    </script>
