<div class="main-menu flex-grow-1">
    <ul class="menu-list sidemenu">
        ...
        <li class="collapsed">
            ...
            <!-- Menu: Sub menu ul -->
            <ul class="sub-menu collapse {{ (request()->is('warehouse','user-role-list','user_role','tube','container','machine','branch','departments','add-department','tax','add-tax','payment-method','income-category','expense-category','country','state','city')) ? 'show' : '' }} {{ (request()->segment(1) == 'edit-user_role') ? 'show' : '' }}{{ (request()->segment(1) == 'permission-staff') ? 'show' : '' }}{{ (request()->segment(1) == 'edit-department') ? 'show' : '' }} {{ (request()->segment(1) == 'edit-tax') ? 'show' : '' }}" id="master">
                ...
                <li><a class="ms-link {{ (request()->is('user-role-list','user_role','edit-user_role','permission-staff')) ? 'active' : '' }} {{ (request()->segment(1) == 'edit-user_role') ? 'active' : '' }} {{ (request()->segment(1) == 'permission-staff') ? 'active' : '' }}" href="{{ url('/user-role-list') }}">User Role</a></li>
       ...
       <li class="collapsed">
    <a class="m-link" data-bs-toggle="collapse" data-bs-target="#client-master" href="#">
        <i class="fa fa-user"></i>
        <span class="ms-2">Client Master</span>
        <span class="arrow fa fa-angle-right ms-auto text-end"></span>
    </a>
    <!-- Menu: Sub menu ul -->
    <ul class="sub-menu collapse {{ (request()->is('master-clients','update_test_prices/{id}')) ? 'show' : '' }}" id="client-master">
        <li><a class="ms-link {{ (request()->is('master-clients','update_test_prices/{id}')) ? 'active' : '' }}" href="{{ url('/master-clients') }}">Clients</a></li>
