...
.tooltips:hover .tooltiptext {
                ...
                <div class="row g-4">
                    ...
                    @csrf
                        <div class="card">
                            ...
                            <div class="card-body">
                                <input type="text" class="form-control form-control-lg" name="allsearch" autocomplete="off" id="allsearch" placeholder="Search by Name / contact number/ Document Number">
                                <div id="customerdatalist"></div> 
                            </div>
                            <div class="card-body">
                                <div class="row g-4">
                                    <div class="col-sm-12">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="date" class="form-control form-control-lg" name="dob" id="dob" onChange="agecal()">
  ...
  <script>
   function agecal(){
      ...
      const byear = String(total).slice(0,4); 
     var date = new Date();
                 ...
                 <option value="O positive">O positive</option>
                  <option value="O negative">O negative</option>                          
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="number" class="form-control form-control-lg" name="emergencyno" id="emergencyno">
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="emailalert" style="display:none ;"></div>
                                    </div>
                                ...
                                <div class="row">
                                 ...
                                 <div class="alert-danger pt-1 pb-1 px-1 py-1" id="provideralert" style="display:none ;">Please select insurance provider</div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 mt-3">
                                        <label class="form-label">Insurance Number<span class="red"> *</span></label>
                                        <input type="text" class="form-control form-control-lg" name="insuranceno" id="insuranceno">
                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="numberalert" style="display:none ;">Please enter insurance Number</div>
                                    </div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 mt-3">
                                        <label class="form-label">Expiry Date<span class="red"> *</span></label>
                                        <input type="date" class="form-control form-control-lg" name="insuranceexpirydate" id="insuranceexpirydate">
                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="datealert" style="display:none ;">Please select expiry date</div>
                                ...
                                <div class="row" > 
                                    ...
                                    <div class="col-lg-4 col-md-4 mt-3">
                                        <label class="form-label">ID Number <span class="red">*</span></label>
                                    ...
                                    <div class="col-lg-7 col-md-7 mt-3">
                                        ...
                                        <input type="file" class="form-control" name="docattachement" id="docattachement" accept=".pdf,.jpg,.png,.jpeg,.gif" onchange="return documentAttachValidation();">
                            ...
                            <div class="modal fade" id="payment" tabindex="-1">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="row g-4">
                                            ...
                                            <div style="margin:0;padding:0;"><span class="reg_split"></span></div>
                                           
                                            <div style="display: none" class="reg_cash_amount">
                                                <div class="form-group" style="margin-top: 20px;">
                                                    ...
                                                    <div><input type="hidden" value="0" name="SplitId" id="SplitId"></div>
                                                    <div class="col-sm-12"> 
                                                    <select class="form-select form-select-lg" name="paymentmethod1" id="paymentmethod1">
                                                        <option value="0">- Please Select -</option>                                            
                                                        @foreach ($paymentmethods as $paymentmethod)
                                                        <option value="{{$paymentmethod->id}}">{{$paymentmethod->paymentmethod}}</option>
                                                        @endforeach                                          
                                                    </select>
                                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="paymentmethodalert1" style="display:none ;">Please select payment method</div>  
                                                    </div>
                                                </div>  
                                                ...
                                                <div class="form-group" style="margin-top: 20px;">
                                                    ...
                                                    <div><input type="hidden" value="0" name="SplitId" id="SplitId"></div>
                                                    <div class="col-sm-12"> 
                                                        <input type="text" class="form-control form-control-lg" name="totalamont1" id="totalamont1"> 
                                                        <input type="hidden" class="form-control form-control-lg" name="totalPayamont" id="totalPayamont"> 
                                                        <input type="hidden" class="form-control form-control-lg" name="totalPayamount" id="totalPayamount"> 
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="paidamountalert1" style="display:none ;">Please enter amount</div>  
                                                    </div>
                                                </div>  
                                            <br>    
                                            
                                           <div class="col-sm-12"> 
                                              <a style="cursor:pointer;" class="btn btn-primary" onclick="normalRangeValidation();">Add More +</a>
                                             <!-- <button type="button" class="btn btn-default" data-bs-dismiss="modal" aria-label="Close">Close</button>-->
                                            </div>
                                            <br>
                                            <table id="normalrange" class="table card-table table-hover align-middle mb-1 mt-0" style="width: 100%;">
                                              <thead>
                                                <tr>
                                                  <th>#</th>
                                            ...
                                            function normalRangeValidation() {
                                                var paymentmethod1 = Number(document.newregistration.paymentmethod1.value);
                                                if(paymentmethod1 == 0)
                                                {
                                                    $('#paymentmethod1').focus().addClass('error');
                                                }
                                                else
                                                {
                                                     $('#paymentmethod1').removeClass('error');
                                                    var paymentAmount = $('#totalPayamont').val();
                                                    var paymentTotAmount = $('#totalPayamount').val();
                                                    var payamount1 = Number(document.newregistration.totalamont1.value);
                                                    var SumPay = paymentAmount - payamount1;
                                                    
                                                    if(SumPay >= 0 && SumPay <= paymentTotAmount)
                                                    {
                                                        var paymentmethod1 = Number(document.newregistration.paymentmethod1.value);
                                                        var method = paymentmethod1 === 1 ? 'Cash' : 'Card';
                                                       
                                                        var payamount1 = Number(document.newregistration.totalamont1.value);
                                                        
                                                        var totl = paymentAmount - payamount1;
                                                        var tableRef = document.getElementById('normalrange').getElementsByTagName('tbody')[0];
                                                        var nums = tableRef.rows.length;
                                                        var counts = nums + 1;
                                                        
                                                        var myHtmlContent = '<tr><td>' + counts + '</td><td>' + payamount1 + '</td><td>' + method + '</td><td><button class="btn btn-danger btn-sm" onclick="deleteRow(this)"><i class="fa fa-trash"></i></button></td></tr>';
                                                        
                                                        $('#normalrange tbody').append(myHtmlContent);
                                                        $('#totalamont1').val(totl);
                                                        $('#totalPayamont').val(totl);
                                                    ...
                                                    {
                                                        var paymentTotAmount = $('#totalPayamount').val();
                                                        swal("Total Amount is: "+paymentTotAmount+" Exceeded");
                                                    }
                                                }
                                            ...
                                            function refreshPaymentMethodOptions() {
                                                var paymentMethodSelect = $('#paymentmethod1');
                                                
                                                // Clear existing options
                                                paymentMethodSelect.empty();
                                                
                                                // Add default option
                                                paymentMethodSelect.append('<option value="0">- Please Select -</option>');
                                                
                                                // Populate with updated options
                                                // Replace this part with your own logic to fetch and populate the options
                                                @foreach ($paymentmethods as $paymentmethod)
                                                    paymentMethodSelect.append('<option value="{{$paymentmethod->id}}">{{$paymentmethod->paymentmethod}}</option>');
                                                @endforeach
                                            }
                                            
                                             function deleteRow(button) {
                                                var paymentAmount =  parseFloat($('#totalPayamont').val());
                                                var row = button.parentNode.parentNode;
                                                row.parentNode.removeChild(row);
                                                var secondColumnValue =  parseFloat(row.cells[1].innerText.trim());
                                                var totl = paymentAmount + secondColumnValue;
                                                $('#totalamont1').val(totl);
                                                $('#totalPayamont').val(totl);
                                            ...
                                            $(document).ready(function() {
                                                $('#totalPayamont').on('input', function() {
                                                    var paymentAmount = $(this).val();
                                                    var addButton = $('#addMoreButton');
                                                    if (paymentAmount == 0) {
                                            ...
                                            <a style="cursor:pointer;" class="btn btn-primary" onclick="finalSplitsubmission();">Save</a>
                                            <button type="button" class="btn btn-default"  aria-label="Cancel" Onclick="resetModal()">Cancel</button>  
                                            </div>
                                ...
                                <script>
                                              function resetModal() {
                                                ...
                                                var amount =  $('#totalamont').val();
                                                // Reset the table and remove added rows
                                                $('#normalrange tbody').empty();
                                               $('#totalamont1').val(amount);
                                                $('#totalPayamont').val(amount);
                                                $('#paymentmethodalert1').hide();
                                                $('#paidamountalert1').hide();
                                                
                                                // Refresh payment method options
                                                refreshPaymentsMethodOptions();
                                              }
                                            
                                              function refreshPaymentsMethodOptions() {
                                               // var paymentMethodSelect = $('#paymentmethod');
                                               // var paymentMethodOptions = paymentMethodSelect.data('original-options');
                                               ...
                                               // paymentMethodSelect.append('<option value="0">- Please Select -</option>');
                                                ...
                                                // Populate with original options
                                               // paymentMethodSelect.append(paymentMethodOptions);
                                               var paymentMethodSelect = $('#paymentmethod');
                                              ...
                                              $(document).ready(function() {
                                                // Store the original payment method options for later use
                                                var paymentMethodSelect = $('#paymentmethod');
                                                paymentMethodSelect.data('original-options', paymentMethodSelect.html());
                                                
                                                // Bind the resetModal function to the Close button click event
...
<!-- EDIT doc POPUP STARTS HERE -->
     <form class="row g-3" id="editdoc" name="editdoc" enctype="multipart/form-data">
        @csrf 
                        ...
                        <div class="modal-dialog modal-lg modal-dialog-scrollable">
                            <div class="modal-content">
                                ...
                                <div class="modal-body custom_scroll">
                                    ...
                                    <!--<div class="col-lg-4 col-md-4 mt-3">-->
                                    <!--    <label class="form-label">Document Type <span class="red">*</span></label>-->
                                    <!--    <select class="form-select form-select-lg" name="documenttype" id="doc_type">-->
                                    <!--        <option value="">- Please Select -</option>-->
                                    ...
                                    <div class="col-lg-4 col-md-4 mt-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="documentnumber" id="doc_number">
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="documentnumberalert" style="display:none ;">Please enter</div>
                                    </div>
                                    <div class="col-lg-4 col-md-4 mt-3">
                                        <label class="form-label">Document Expiry Date <span class="red">*</span></label>
                                        <input type="date" class="form-control form-control-lg" name="docexpirydate" id="exp_date">
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="docexpirydatealert" style="display:none ;">Please enter </div>
                                    </div>
                                  ...
                                  <div class="col-lg-7 col-md-7 mt-3">
                                        <label class="form-label">Attach File <span class="red" > *(Allowed:.jpg\.jpeg\.png\.gif\.pdf)</span></label>
                                        <input type="file" class="form-control" name="docS" id="docS" accept=".pdf,.jpg,.png,.jpeg,.gif" onchange="return documenteditAttachValidation();">      
                            ...
                            <input type="hidden" class="form-control form-control-lg" id="userid" name="userid" >
                                        <!--<a style="cursor:pointer;" class="btn btn-primary mt-3">Save Document</a>-->
                                        <!--<button type="button" id="edit-modal-close" class="btn btn-secondary3">Cancel</button>-->
                            <button type="submit" id="SaveDocument" class="btn btn-secondary" >save</button>
                            <button type="button" id="edit-modal-close" class="btn btn-secondary3">Cancel</button>
        ...
        $.ajax({
            ...
            success:function(regidata){
               ...
               $.each(regidata.custdocuments, function(index, doc) {
                    var num = index + 1;
                    dochtml += '<tr><td>' + num + '</td><td>' + doc.documenttype + '</td><td>' + doc.documentnumber + '</td><td>' + doc.documentexpirydate + '</td><td class="text-center"><div class="btn btn-link btn-sm text-success tooltips"><i class="fa fa-eye"></i><span class="tooltiptext"><embed src="{{ url("uploads") }}/' + doc.documentfilename + '#toolbar=0" type="application/pdf" width="200" height="auto"></span></div></td><td class="text-center"><span class="btn btn-link btn-sm text-danger delete" onclick="return deletedoc(0,'+doc.docid+',this);"><i class="fa fa-trash"></i></span><span class="btn btn-link btn-sm text-secondry"  onclick="return editview(0,'+doc.docid+',this);" data-bs-toggle="modal" data-bs-target="#edit-doc-type('+doc.docid+')";"><i class="fa fa-edit"></i></span></td></tr>';
                });
...
// Document edit modal starts

  function editview(cid,deleteid,trid){
        var token = $('input[name="_token"]').val();
        $.ajax({
        url:"{{ route('doc.editview')}}",
        type : 'POST',
        data:{
            id:deleteid,
            _token:token
...
<script>
   $(document).ready(function() {
    ...
    $('#editdoc').on('submit', function(event) {
        ...
        $.ajax({
            url: "{{ route('doc-edit-vw') }}", // Replace with your controller route
            method: "POST",
            data: formData,
            contentType: false,
            processData: false,
            ...
            success: function(response) {
                ...
                if (response.success == 1) {
                    $('#edit-doc-type').modal('hide');
                    $('#tabledocumentlist tbody').html('');
                    var dochtml = "";
                    var num;
                    $.each(response.custdocuments, function(index, doc) {
                        var num = index + 1;
                        dochtml += '<tr><td>' + num + '</td><td>' + doc.documenttype + '</td><td>' + doc.documentnumber + '</td><td>' + doc.documentexpirydate + '</td><td class="text-center"><div class="btn btn-link btn-sm text-success tooltips"><i class="fa fa-eye"></i><span class="tooltiptext"><embed src="{{ url("uploads") }}/' + doc.documentfilename + '#toolbar=0" type="application/pdf" width="200" height="auto"></span></div></td><td class="text-center"><span class="btn btn-link btn-sm text-danger delete" onclick="return deletedoc(0,' + doc.docid + ',this);"><i class="fa fa-trash"></i></span><span class="btn btn-link btn-sm text-secondry" onclick="return editview(0,' + doc.docid + ',this);" data-bs-toggle="modal" data-bs-target="#edit-doc-type(' + doc.docid + ')";"><i class="fa fa-edit"></i></span></td></tr>';
                    });
...
function finalSplitsubmission() {
       
        var sumPaidAmount = 0;
        var tableData = [];
        if ($('#normalrange tbody tr').length === 0) {
    swal("Please Click addmore button add rows before submitting.");
    return false; // Stop form submission
  }
        $('#normalrange tbody tr').each(function() {
            var row = $(this);
            var count = row.find('td:eq(0)').text();
            var paidAmount =parseFloat(row.find('td:eq(1)').text());
       
             sumPaidAmount += paidAmount;
            
            var paymentMethod = row.find('td:eq(2)').text();
            tableData.push({
              count: count,
 ...
 $('#totalamont').val(sumPaidAmount);

// Convert the tableData to a JSON string
...
{   
   /* $('#payment').modal('show');
    ...
    var testlisttbltr = testlisttable.rows.length;
    	...
    	if(document.newregistration.insuranceno.value == ''){
        	document.getElementById('numberalert').style.display = 'block'; 
        	document.newregistration.insuranceno.focus();  
        	return false;     
    	}
    	
    	if(document.newregistration.insuranceexpirydate.value == ''){
        	document.getElementById('datealert').style.display = 'block'; 
        	document.newregistration.insuranceexpirydate.focus();  
        	return false;     
    	}
    	if(doctbltr == 0){
...
//return false;
   ...
   $('#totalPayamont').val(strval);
   $('#totalPayamount').val(strval);
   $('#totalamont1').val(strval);
   $('#payment').modal('show');
    return false;   
}
    ...
    var allowedExtensions = /(\.jpg|\.jpeg|\.png|\.gif|.pdf)$/i;
            if (!allowedExtensions.exec(filePath)) {
               //alert('Invalid file type');
                ...
                document.getElementById('docattachementalert').innerHTML = '(Allowed:.jpg\.jpeg\.png\.gif\.pdf)';
                return false;
            } else {
                document.getElementById('docattachementalert').style.display = 'none'; 
            }
}
function documenteditAttachValidation() {  
    ...
    var allowedExtensions = /(\.jpg|\.jpeg|\.png|\.gif|.pdf)$/i;
            if (!allowedExtensions.exec(filePath)) {
               //alert('Invalid file type');
                ...
                document.getElementById('docattachementalert1').innerHTML = '(Allowed:.jpg\.jpeg\.png\.gif\.pdf)';
                return false;
            } else {
...
$(document).ready(function(){ 
    $('#allsearch').keyup(function(){  
        ...
        if(allsearch != '')
        {
            var token = $('input[name="_token"]').val();
            $.ajax({
                url:"{{ route('autocomplete.customerdata') }}",
                method:"POST",
                data:{allsearch:allsearch, _token:token},
                success:function(data){ 
                    $('#customerdatalist').fadeIn();  
                    $('#customerdatalist').html(data);  
                }
            }); 
        } else {
            $('#customerdatalist').fadeOut();  
    ...
    $('#documentnumber').keyup(function(){  
        ...
        if(documentnumber != '')
        {
            ...
            $.ajax({
                ...
                method:"POST",
                data:{documentnumber:documentnumber, _token:token},
                success:function(data){ 
...
$(".reg_cash").click(function () {
    ...
    if ($(this).is(":checked")) {
        ...
        testlist ='<input type="hidden" value="1" name="SplitId" id="SplitId">';
        $(".reg_split").html(testlist);
