                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title m-0">Departments</h6> <a href="{{ url('/add-department') }}" class="btn btn-primary">Add Department</a>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>{{ $value->department_name }}</td>
                 <td>{{ $value->department_namear }}</td>
                <td class="text-center">{{ $date }}</td>
                <td class="text-center">
                    <a href="{{ 'edit-department/'.$value->designationid }}" class="btn btn-link btn-sm text-secondry" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" aria-label="Edit">
                                                    <i class="fa fa-edit" style="color:#555CB8;"></i>
                                                </a>
                                                <?php if($value->designationstatus =='1') { ?> 
                                                <a href="{{ 'block-designation/'.$value->designationid }}"  onclick="return confirm('Do you want to block this designation?')" class="btn btn-link btn-sm text-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Active" aria-label="Active">
                                                    <i class="fa fa-ban" style="color:#198754;"></i>
                                                    
                                                </a>
                                                <?php } else { ?>
                                                    <a href="{{ 'unblock-designation/'.$value->designationid }}" onclick="return confirm('Do you want to unblock this designation?')" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Blocked" aria-label="Blocked">
