       ...
       <div class="page-body px-xl-4 px-sm-2 px-0 py-lg-2 py-1 mt-3">
            <div class="container-fluid">
                ...
                <!-- COL 3 STARTS HERE -->
                    ...
                    <div class="row g-4">
                <form class="row g-3" id="editpurchase" name="editpurchase" method="post" action="{{ url('update-purchase-item') }}">                          
                @csrf
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title mb-0">Edit Purchase Item</h6>
                            </div>
                            ...
                            <div class="card-body">
                                <div class="row g-4">
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="itemname" value="{{$itempurchases->itemname}}" > 
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="itemnamealert" style="display:none ;">Please enter item name</div>                                      
                                       
                                    </div>
                                    <div class="col-sm-6 text-end">
                                            <label class="form-label">Item Name (Arabic)<span class="red">*</span></label>                                        
                                            <input type="text" dir="rtl" class="form-control form-control-lg" name="itemnamearabicedit" value="{{$itempurchases->item_name_arabic}}"> 
                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="itemnamealertar" style="display:none ;">Please enter item name</div>                                      
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="serialnumber" value="{{$itempurchases->serialnumber}}" > 

                                    </div>

                                    <div class="col-sm-6">
                                        <label class="form-label">Item Code <span class="red">*</span></label>
                                        <input type="text" class="form-control form-control-lg" name="itemcode" value="{{$itempurchases->itemcode}}" > 
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select name="categoryid" id="categoryid" onchange="loadsubcategory(this.value)" placeholder="--Please Select--">
                                            ...
                                            <option value="{{$listcategory->id}}" {{ ( $listcategory->id == $itempurchases->category_id) ? 'selected' : '' }}>{{$listcategory->cat_name}}</option>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select name="subcategoryname" id="subcategoryname" placeholder="--Please Select--" >
                                                    <option value="">--Please Select--</option> 
                                                    @foreach ($subcategoryname as $listsubcategory)
                                                    <option value="{{$listsubcategory->id}}" {{ ( $listsubcategory->id == $itempurchases->subcategory_id) ? 'selected' : '' }}>{{$listsubcategory->subcat_name}}</option>
                                                    @endforeach
                                            </select>
                                    </div>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select name="brandid" id="brandid" placeholder="--Please Select--">
                                            ...
                                            <option value="{{$listbrand->id}}" {{ ( $listbrand->id == $itempurchases->brand_id) ? 'selected' : '' }}>{{$listbrand->brand_name}}</option>
                                            @endforeach
                                        </select>
                                        ...
                                        <label class="form-label">Warehouse <span class="red">*</span></label>                          
                                            <select name="warehousename" id="warehousename" placeholder="--Please Select--">
                                                    ...
                                                    <option value="{{$listwarehouse->id}}" {{ ( $listwarehouse->id == $itempurchases->warehouse_id) ? 'selected' : '' }}>{{$listwarehouse->warehouse_name}}</option>
                                                    @endforeach
                                            </select>
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="itemcost"  value="{{$itempurchases->itemcost}}"  > 
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="sellingprice" value="{{$itempurchases->sellingprice}}" > 
                                     ...
                                     <div class="col-sm-6">
                                        ...
                                        <select name="taxid" id="taxid" placeholder="--Please Select--">
                                            ...
                                            <option value="{{$listtax->id}}" {{ ( $listtax->id == $itempurchases->itemvat) ? 'selected' : '' }}>{{$listtax->taxname}}</option>
                                            @endforeach
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <!-- <input type="text" class="form-control form-control-lg" id="vatmethod" name="vatmethod">  -->
                                            <option value="">--Please Select--</option>
                                            <option value="exclusive" {{ ( $itempurchases->vatmethod == 'exclusive') ? 'selected' : '' }}>Exclusive</option>
                                            <option value="inclusive" {{ ( $itempurchases->vatmethod == 'inclusive') ? 'selected' : '' }}>Inclusive</option>
                                        </select>
                                    ...
                                    <div class="col-sm-6">
                                        <label class="form-label">Expiry Date</label>
                                         <input type="text" class="form-control form-control-lg flatpickr expirydate flatpickr-input" name="expirydate" value="{{$itempurchases->expirydate}}"> 
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <select name="unitid" id="unitid" placeholder="--Please Select--">
                                            ...
                                            <option value="{{$listunit->id}}" {{ ( $listunit->id == $itempurchases->unit_id) ? 'selected' : '' }}>{{$listunit->unit_name}}</option>
                                            @endforeach
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="openingstock"  value="{{$itempurchases->openingstock}}"> 
...
function formValidation() 
{
    document.getElementById('itemnamealert').style.display = 'none';
       document.getElementById('itemnamealertar').style.display = 'none';
    ...
    if(document.editpurchase.itemname.value == ''){
        document.getElementById('itemnamealert').style.display = 'block'; 
        document.editpurchase.itemname.focus();  
        return false;     
    }if(document.editpurchase.itemnamearabicedit.value == ''){
        document.getElementById('itemnamealertar').style.display = 'block'; 
        document.editpurchase.itemnamearabicedit.focus();  
        return false;     
    }if(document.editpurchase.itemcode.value == ''){
        document.getElementById('itemcodealert').style.display = 'block'; 
        document.editpurchase.itemcode.focus();  
        return false;     
    } if(document.editpurchase.categoryid.value == ''){
        document.getElementById('categoryidalert').style.display = 'block'; 
        document.editpurchase.categoryid.focus();  
        return false;     
    } if(document.editpurchase.brandid.value == ''){
        document.getElementById('brandidalert').style.display = 'block'; 
       document.editpurchase.brandid.focus();  
        return false; 
    } if(document.editpurchase.warehousename.value == ''){
        document.getElementById('warehousealert').style.display = 'block'; 
        document.editpurchase.warehousename.focus();  
        return false; 
    } if(document.editpurchase.itemcost.value == ''){
        document.getElementById('itemcostalert').style.display = 'block'; 
        document.editpurchase.itemcost.focus();  
        return false;     
    } if(IsNumeric(document.editpurchase.itemcost.value)==false){
        document.getElementById('itemcostalert').style.display = 'block'; 
        document.getElementById("itemcostalert").innerHTML="Invalid item cost! Please re-enter";
        document.editpurchase.itemcost.select();
        document.editpurchase.itemcost.focus(); 
        return false;
    } if(document.editpurchase.sellingprice.value == ''){
        document.getElementById('sellingpricealert').style.display = 'block'; 
        document.editpurchase.sellingprice.focus();  
        return false;     
    } if(IsNumeric(document.editpurchase.sellingprice.value)==false){
        document.getElementById('sellingpricealert').style.display = 'block'; 
        document.getElementById("sellingpricealert").innerHTML="Invalid selling price! Please re-enter";
        document.editpurchase.sellingprice.select();
        documenteditpurchase.sellingprice.focus(); 
        return false;
     } if(document.editpurchase.taxid.value != '')
            if(document.editpurchase.vatmethod.value == ''){
                document.getElementById('vatmethodalert').style.display = 'block'; 
                document.editpurchase.vatmethod.focus();  
                return false;

            } if(document.editpurchase.unitid.value == ''){
                document.getElementById('unitidalert').style.display = 'block'; 
                document.editpurchase.unitid.focus();  
                return false; 
            }
   
document.editpurchase.submit();
return true;
};
