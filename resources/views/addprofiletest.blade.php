                            ...
                            <div class="card-body">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="profilenamear">
                                    ...
                                    <div class="col-sm-2">
                                     ...
                                     <div class="col-sm-2">
                                       ...
                                       <div class="col-sm-6">
                                        ...
                                        <input  class="form-control" name="test_description">
                                        <!--<textarea class="form-control" name="test_description" rows="4"></textarea>-->
                                    </div>
                                      <div class="col-sm-6">
                                        <label class="form-label">Test Description(Arabic)</label>
                                        <input  class="form-control" name="test_descriptionar">
                                        <!--<textarea class="form-control" name="test_description" rows="4"></textarea>-->
                                    </div>
...
for(var i=0; i < chks.length; i++){
    ...
    document.getElementById('imageUploadAlert').style.display = 'none'; 
    ...
    if(document.addprofiletestform.profilename.value == ''){
        ...
        document.getElementById('profilenamealertar').style.display = 'block'; 
        ...
        return false;     
    } else if(document.addprofiletestform.image.value == ''){
        document.getElementById('imageUploadAlert').style.display = 'block'; 
        document.addprofiletestform.image.focus();  
        return false;     
    }
