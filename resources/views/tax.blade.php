                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title m-0">Taxes</h6> <a href="{{ url('/add-tax') }}" class="btn btn-primary">Add Tax</a>
                            </div>
                            @if(\Session::get('success'))
                                ...
                                @endif
                            <div class="card-body">
                                <table id="tbltaxnew" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th>#</th>
                                            <th>Name</th>
                                    ...
                                    @foreach($taxes as $key => $tax)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ ucfirst($tax->taxtype) }}</td>
                                            
                                            <td class="text-center">
                                                <a href="{{ 'edit-tax/'.$tax->id }}" class="btn btn-link btn-sm text-secondry" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" aria-label="Edit">
                                                    <i class="fa fa-edit" style="color:#555CB8;"></i>
                                                </a>
                                                
                                                <?php if($tax->status =='1')  { ?>
                                                <a href="{{ 'block-tax/'.$tax->id }}"  onclick="return confirm('Do you want to block this tax?')" class="btn btn-link btn-sm text-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Active" aria-label="Active">
                                                    <i class="fa fa-ban" style="color:#198754;"></i>
                                                    
                                                </a>
                                                <?php } else { ?>
                                                    <a href="{{ 'unblock-tax/'.$tax->id }}" onclick="return confirm('Do you want to unblock this tax?')" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Blocked" aria-label="Blocked">
