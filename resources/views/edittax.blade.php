...
<div class="page-body px-xl-4 px-sm-2 px-0 py-lg-2 py-1 mt-3">
            <div class="container-fluid" style="min-height:450px;" >
                <div class="row">
                    ...
                    <div class="row g-4" >
                    <form class="row g-3" id="addtax" name="addtax" method="post" action="{{ url('edit-tax/'.$tax->id) }}">                            
                    @csrf
                    <div class="col-lg-12 col-md-12 col-sm-12" >
                        <div class="card" >
                            <div class="card-header">
                                <h6 class="card-title mb-0">Update Tax</h6>
                            </div>
                            <div class="card-body">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="taxname" value="{{$tax->taxname}}">
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="taxnamealert" style="display:none ;">Please enter tax name</div>
                                    </div>
                                    
                                     <div class="col-sm-3">
                                        <label class="form-label">Name(Arabic) <span class='red'>*</span></label>
                                        <input type="text" class="form-control form-control-lg" name="taxnamear" value="{{$tax->taxnamear}}">
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="taxnamealertar" style="display:none ;">الرجاء إدخال الاسم الضريبي</div>
                                    </div>
                                    <div class="col-sm-3">
                                        <label class="form-label">Rate <span class='red'>*</span></label>
                                        <input type="number" class="form-control form-control-lg" name="taxrate" value="{{$tax->taxrate}}">
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="taxratealert" style="display:none ;">Please enter tax rate</div>
                                    </div>

                                    <div class="col-sm-3">
                                        <label class="form-label">Type <span class='red'>*</span></label>
                                        <select id="newdepart" class="form-select form-select-lg" tabindex="-98" name="taxtype">
                                            <option value="">-- Please Select --</option>
                                            <option value="percentage" {{ ($tax->taxtype == 'percentage') ? 'selected' : '' }}>Percentage</option>
                                            <option value="fixed" {{ ($tax->taxtype == 'fixed') ? 'selected' : '' }}>Fixed</option>
                                        </select>                                        
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="taxtypealert" style="display:none ;">Please select tax type</div>
...
function formValidation() 
{
    ...
    document.getElementById('taxtypealert').style.display = 'none';
     document.getElementById('taxnamealertar').style.display = 'none';
    ...
    if(document.addtax.taxname.value == ''){
        ...
        return false;     
    }else if(document.addtax.taxnamear.value == ''){
        document.getElementById('taxnamealert').style.display = 'block'; 
        document.addtax.taxnamear.focus();  
        return false;     
    }
