            ...
            <div class="container-fluid">
                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12 col-md-12 ">
                        <div class="card text-center wellcome-back" style="background-position: 100% 100%;background-size: 360px auto; ')">
                            <div class="card-body">
                                <h4 class="card-title mt-4">Welcome To eLab Application!!</h4>
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div class="flex-fill ms-3 text-truncate">
                                    ...
                                    @foreach ($customerCount as $index => $customer)
                                    <div><span class="h6 mb-0 fw-bold">{{ $customer->total_count }}</span></div>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div class="flex-fill ms-3 text-truncate">
                                    <div class="small text-uppercase">Invoice Generated</div>
                                    @foreach ($inoviceCount as $index => $invoice)
                                    <div><span class="h6 mb-0 fw-bold text-danger">{{ ($invoice->total_count)  }}</span></div>
                                    @endforeach
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div class="flex-fill ms-3 text-truncate">
                                    <div class="small text-uppercase">Paid Amount</div>
                                    <div><span class="h6 mb-0 fw-bold">{{ number_format($invoicePaidAmount, 2) }}</span> </div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        <div class="card">
                            <div class="card-body d-flex align-items-center">
                                <div class="avatar rounded-circle no-thumbnail bg-light"><i class="fa fa-briefcase fa-lg"></i></div>
                                <div class="flex-fill ms-3 text-truncate">
                                    <div class="small text-uppercase">Pending Amount</div>
                                    <div><span class="h6 mb-0 fw-bold text-danger">{{ number_format($invoiceDueAmount, 2) }}</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div class="flex-fill ms-3 text-truncate">
                                    ...
                                    <div><span class="h6 mb-0 fw-bold">{{ number_format($expenseCount, 2) }}</span> <small class="text-danger"></small></div>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body d-flex align-items-center">
                                ...
                                <div class="flex-fill ms-3 text-truncate">
                                    ...
                                    <div><span class="h6 mb-0 fw-bold">0</span></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-xxl-9 col-xl-8 col-lg-8 col-md-12">
                        <div class="card">
                            <div class="card-header">
                                <h6 class="card-title m-0">Weekly Payment</h6>
