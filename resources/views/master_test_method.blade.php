...
<style>
            ...
            <div class="container-fluid">
                <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h6 class="card-title m-0">Test Method</h6><a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-sample-type">Add Test Method</a>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="testmethodnew" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th style="width:3%">#</th>
                                                        <th style="width:45%">Test Method</th>
                                                        <th style="width:45%">Test Method (Arabic)</th>
                                                        <th style="width:7%"class="text-center">Actions</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                @foreach($testmethods as $key => $value) 
                                                    <tr>
                                                        <td>{{ ++$key }}</td>
                                                        <td>{{ $value->testmethod }}</td>
                                                        <td>
                                                            @php if($value->testmethod_arabic) { $arabicname = $value->testmethod_arabic; } else { $arabicname = '-NA-'; } @endphp
                                                        {{ $arabicname }}</td>
                                                        <td class="text-center">
                                                            ...
                                                            <a href="{{ 'block-test-method/'.$value->id }}"  onclick="return confirm('Do you want to block this test method?')" class="btn btn-link btn-sm text-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Active" aria-label="Active">
                                                                <i class="fa fa-ban" style="color:#198754;"></i>                                                                
                                                            </a>
                                                            <?php } else { ?>
                                                                <a href="{{ 'unblock-test-method/'.$value->id }}" onclick="return confirm('Do you want to unblock this test method?')" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Blocked" aria-label="Blocked">
                    ...
                    @endforeach
                            ...
                            <form class="row g-3" id="addtestmethod" name="addtestmethod" method="post" action="{{ route('testmethod.add') }}">                            
                                @csrf
                                <div class="modal fade" id="add-sample-type" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Test Method</h5>
                                                <button type="button" id="add-modal-close-x" class="btn-close"></button>
                                            </div>
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Test Method <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="testmethodname" id="testmethodname" >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="testmethodnamealert" style="display:none ;">Please enter test method </div>                                                
                                                    </div>
                                                    
                                                    <div class="col-sm-6 text-end">
                                                        <label class="form-label">Test Method (Arabic)<span class="red">*</span></label>
                                                        <input type="text" dir="rtl" class="form-control form-control-lg" name="arabictestmethodname" id="arabictestmethodname" >
                                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="testmethodnamealertar" style="display:none ;">Please enter test method </div>                                                

                                                    </div>
                                                </div>                                
                                            </div>
                                            <div class="modal-footer">
                                                <a class="btn btn-primary" onclick="addtestmethodValidation();">Save</a>
                            ...
                            <form class="row g-3" name="edittestmethod" method="post" action="{{ route('testmethod.edit') }}">                            
                                @csrf
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Test Method <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="testmethodnameedit" id="testmethodnameedit" >
                                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="testmethodnameeditalert" style="display:none ;">Please enter test category </div>                                                

                                                    </div>
                                                    <div class="col-sm-6 text-end">
                                                        <label class="form-label">Test Method (Arabic)<span class="red">*</span></label>
                                                        <input type="text" dir="rtl" class="form-control form-control-lg" name="arabictestmethodnameedit" id="arabictestmethodnameedit" >
                                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="testmethodnameeditalertar" style="display:none ;">Please enter test category </div>                                                
                                            ...
                                            <input type="hidden" class="form-control form-control-lg" name="hiddenid" id="hiddenid"  >
                                                <a class="btn btn-primary" onclick="edittestmethodValidation();">Save</a>
    ...
    $('#add-modal-close-x, #add-modal-close').click(function() {
        $('#testmethodname').val('');
        $('#arabictestmethodname').val('');
        $('#testmethodnamealert').hide();
        $('#add-sample-type').modal('hide');
    });

    $('#edit-modal-close-x, #edit-modal-close').click(function() {
        $('#testmethodnamealertedit').hide();
        $('#edit-sample-type').modal('hide');
    });

   
    function addtestmethodValidation() {
        document.getElementById('testmethodnamealert').style.display = 'none';
        document.getElementById('testmethodnamealertar').style.display = 'none';
        if(document.addtestmethod.testmethodname.value == ''){
            document.getElementById('testmethodnamealert').style.display = 'block';  
            document.addtestmethod.testmethodname.focus(); 
            return false;     
        }
         if(document.addtestmethod.arabictestmethodname.value == ''){
            document.getElementById('testmethodnamealertar').style.display = 'block';  
            document.addtestmethod.arabictestmethodname.focus(); 
            return false;     
        }
    document.addtestmethod.submit();
    return true;
    }
    ...
    function editview(id){
        ...
        $.ajax({
            ...
            success: function(response){
                $('#testmethodnameedit').val(response.testmethod);
                $('#arabictestmethodnameedit').val(response.testmethod_arabic);
   ...
   function edittestmethodValidation() {
    // Reset validation errors
    document.getElementById("testmethodnameeditalert").style.display = "none";
    document.getElementById("testmethodnameeditalertar").style.display = "none";

    // Get form values
    var testMethodNameEdit = document.getElementById("testmethodnameedit").value.trim();
    var arabicTestMethodNameEdit = document.getElementById("arabictestmethodnameedit").value.trim();

    // Validate Test Method
    if (testMethodNameEdit === "") {
        document.getElementById("testmethodnameeditalert").style.display = "block";
        return false;
    }

    // Validate Test Method (Arabic)
    if (arabicTestMethodNameEdit === "") {
        document.getElementById("testmethodnameeditalertar").style.display = "block";
        return false;
    }

    // If all validations pass, you can proceed with form submission
    document.forms["edittestmethod"].submit();
}
