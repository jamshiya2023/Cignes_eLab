...
<style>
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="payment-methodnew" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th style="width:3%">#</th>
                                                        <th style="width:90%">Payment Method</th>
                                                        <th style="width:90%">Payment Method(Arabic)</th>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    ...
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Payment Method (Arabic) <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="paymentmethodnamear" id="paymentmethodnamear">
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="paymentmethodnamealertar" style="display:none;">Please enter payment method</div>
                                                    </div>
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                     ...
                                                     <div class="col-sm-6">
                                                        <label class="form-label">Payment Method(Arabic) <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="paymentmethodnameeditar" id="paymentmethodnameeditar" >
                                                        <input type="hidden" class="form-control form-control-lg">
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="paymentmethodnamealerteditar" style="display:none ;">Please enter payment method </div>                                                
                                                    </div>  
                                                </div>                                
                                            </div>
                                            <div class="modal-footer">
    ...
    $('#edit-modal-close-x, #edit-modal-close').click(function() {
     ...
     function addpaymentmethodValidation() {
        ...
        document.getElementById('paymentmethodnamealertar').style.display = 'none';
        ...
        if (document.addpaymentmethod.paymentmethodnamear.value == '') {
            document.getElementById('paymentmethodnamealertar').style.display = 'block';
            document.addpaymentmethod.paymentmethodnamear.focus();
            return false;
        }
    ...
    function editview(id){
        ...
        $.ajax({
            ...
            success: function(response){
                ...
                $('#paymentmethodnameeditar').val(response.paymentmethodar);
    ...
    function editpaymentmethodValidation() {
        ...
        if(document.editpaymentmethod.paymentmethodnameeditar.value == ''){
            document.getElementById('paymentmethodnamealerteditar').style.display = 'block';  
            document.editpaymentmethod.paymentmethodnameeditar.focus(); 
            return false;     
        }
