...
<style>
            ...
            <div class="container-fluid">
                <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h6 class="card-title m-0">Lab Unit</h6><a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-sample-type">Add Lab Unit</a>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="labunitnew" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th style="width:3%">#</th>
                                                        <th style="width:45%">Lab Units</th>
                                                        <th style="width:45%">Lab Units (Arabic)</th>
                                                        <th style="width:7%"class="text-center">Actions</th>
                                                    </tr>
                                                </thead>
                                                <tbody>
                                                @foreach($labunits as $key => $value)
                                                    <tr>
                                                        <td>{{ ++$key }}</td>
                                                        <td>{{ $value->labunit_name }}</td>                                                        
                                                        <td>
                                                            @php if($value->labunit_name_arabic) { $arabicname = $value->labunit_name_arabic; } else {$arabicname = '-NA-';} @endphp
                                                        {{ $arabicname }}</td>
                                                        <td class="text-center">
                                                            ...
                                                            <a href="{{ 'block-lab-unit/'.$value->id }}"  onclick="return confirm('Do you want to block this lab unit?')" class="btn btn-link btn-sm text-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Active" aria-label="Active">
                                                                <i class="fa fa-ban" style="color:#198754;"></i>                                                                
                                                            </a>
                                                            <?php } else { ?>
                                                                <a href="{{ 'unblock-lab-unit/'.$value->id }}" onclick="return confirm('Do you want to unblock this lab unit?')" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Blocked" aria-label="Blocked">
                    ...
                    @endforeach
                            ...
                            <form class="row g-3" id="addlabunit" name="addlabunit" method="post" action="{{ route('labunit.add') }}">                            
                                @csrf
                                <div class="modal fade" id="add-sample-type" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Lab Unit</h5>
                                                <button type="button" id="add-modal-close-x" class="btn-close"></button>
                                            </div>
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Lab Unit <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="labunitname" id="labunitname" >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="labunitnamealert" style="display:none ;">Please enter lab unit </div>                                                
                                                    </div>
                                                    
                                                    <div class="col-sm-6 text-end">
                                                        <label class="form-label">Lab Unit (Arabic)<span class="red">*</span></label>
                                                        <input type="text" dir="rtl" class="form-control form-control-lg" name="arabiclabunitname" id="arabiclabunitname" >
                                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="labunitnamealertar" style="display:none ;">Please enter lab unit </div>                                                

                                                    </div>
                                                </div>                                
                                            </div>
                                            <div class="modal-footer">
                                                <a class="btn btn-primary" onclick="addlabunitValidation();">Save</a>
                            ...
                            <form class="row g-3" name="editlabunit" method="post" action="{{ route('labunit.edit') }}">                            
                                @csrf
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Lab Unit <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="labunitnameedit" id="labunitnameedit" >
                                                        <input type="hidden" class="form-control form-control-lg" name="hiddenid" id="hiddenid"  >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="labunitnamealertedit" style="display:none ;">Please enter lab unit </div>                                                
                                                    </div>  
                                                    
                                                    <div class="col-sm-6 text-end">
                                                        <label class="form-label">Lab Unit Name (Arabic)<span class="red">*</span></label>
                                                        <input type="text" dir="rtl" class="form-control form-control-lg" name="arabiclabunitnameedit" id="arabiclabunitnameedit" >  
                                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="labunitnamealerteditar" style="display:none ;">Please enter lab unit </div>                                                

                                                    </div>
                                                </div>                                
                                            </div>
                                            <div class="modal-footer">
                                                <a class="btn btn-primary" onclick="editlabunitValidation();">Save</a>
    ...
    $('#add-modal-close-x, #add-modal-close').click(function() {
        $('#labunitname').val('');
        $('#arabiclabunitname').val('');
        $('#labunitnamealert').hide();
        $('#add-sample-type').modal('hide');
    });

    $('#edit-modal-close-x, #edit-modal-close').click(function() {
        $('#labunitnamealertedit').hide();
        $('#edit-sample-type').modal('hide');
    });

   
    function addlabunitValidation() {
        document.getElementById('labunitnamealert').style.display = 'none';
        document.getElementById('labunitnamealertar').style.display = 'none';
        if(document.addlabunit.labunitname.value == ''){
            document.getElementById('labunitnamealert').style.display = 'block';  
            document.addlabunit.labunitname.focus(); 
            return false;     
        }
        if(document.addlabunit.arabiclabunitname.value == ''){
            document.getElementById('labunitnamealertar').style.display = 'block';  
            document.addlabunit.arabiclabunitname.focus(); 
            return false;     
        }
    document.addlabunit.submit();
    return true;
    }
    ...
    function editview(id){
        ...
        $.ajax({
            ...
            success: function(response){
                $('#labunitnameedit').val(response.labunit_name);
                $('#arabiclabunitnameedit').val(response.labunit_name_arabic);
    ...
    function editlabunitValidation() {
        if(document.editlabunit.labunitnameedit.value == ''){
            document.getElementById('labunitnamealertedit').style.display = 'block';  
            document.editlabunit.labunitnameedit.focus(); 
            return false;     
        }
         if(document.editlabunit.arabiclabunitnameedit.value == ''){
            document.getElementById('labunitnamealerteditar').style.display = 'block';  
            document.editlabunit.arabiclabunitnameedit.focus(); 
            return false;     
        }
    document.editlabunit.submit();
    return true;
    }
    </script>
