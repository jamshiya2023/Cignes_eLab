...
<style>
            ...
            <div class="container-fluid">
                <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h6 class="card-title m-0">State</h6><a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-sample-type">Add State</a>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="tablestatenew" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th style="width:3%">#</th>
                                                        <th style="width:45%">Country</th>
                                                        <th style="width:45%">State</th>
                                                        <th style="width:45%">State(Arabic)</th>
                                                ...
                                                @foreach($state as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="{{ 'block-state/'.$value->id }}"  onclick="return confirm('Do you want to block this state?')" class="btn btn-link btn-sm text-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Active" aria-label="Active">
                                                                <i class="fa fa-ban" style="color:#198754;"></i>                                                                
                                                            </a>
                                                            <?php } else { ?>
                                                                <a href="{{ 'unblock-state/'.$value->id }}" onclick="return confirm('Do you want to unblock this state?')" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Blocked" aria-label="Blocked">
                    ...
                    @endforeach
                            ...
                            <form class="row g-3" id="addstate" name="addstate" method="post" action="{{ route('state.add') }}">                            
                                @csrf
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4 mb-2">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <select id="countryname" class="form-select form-select-lg" name="countryname">
                                                ...
                                                <div class="row g-4">
                                                    <div class="col-sm-12">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="statename" id="statename" >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="statenamealert" style="display:none ;">Please enter state </div>                                                
                                                    </div>  
                                                     <div class="col-sm-12">
                                                        <label class="form-label">State Name(Arabic)<span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="statenamear" id="statenamear" >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="statenamealertar" style="display:none ;">الرجاء إدخال الولاية </div>                                                
                                                    </div> 
                                                </div>                                
                                            </div>
                                            <div class="modal-footer">
                                                <a class="btn btn-primary" onclick="addstateValidation();">Save</a>
                            ...
                            <form class="row g-3" name="editstate" method="post" action="{{ route('state.edit') }}">                            
                                @csrf
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-12">
                                                        <label class="form-label">Country Name <span class="red">*</span></label>
                                                        <select class="form-select form-select-lg" name="countrynameedit" id="countrynameedit">
                                                        </select>
                                                ...
                                                <div class="row g-4">
                                                    <div class="col-sm-12">
                                                        <label class="form-label">State Name <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="statenameedit" id="statenameedit" >
                                                 ...
                                                 <div class="row g-4">
                                                    <div class="col-sm-12">
                                                        <label class="form-label">State Name(Arabic) <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="statenameeditar" id="statenameeditar" >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="statenamealerteditar" style="display:none ;">Please enter state</div>                                                
                                                    </div>                                    
                                                </div> 
                                            </div>
                                            <div class="modal-footer">
                                            <input type="hidden" class="form-control form-control-lg" name="hiddenid" id="hiddenid"  >
                                                <a class="btn btn-primary" onclick="editstateValidation();">Save</a>
    ...
    function addstateValidation() {
        document.getElementById('countrynamealert').style.display = 'none';
        document.getElementById('statenamealert').style.display = 'none';
        document.getElementById('statenamealertar').style.display = 'none';
        if(document.addstate.countryname.value == ''){
            document.getElementById('countrynamealert').style.display = 'block';  
            document.addstate.countryname.focus(); 
            return false;     
        }
        if(document.addstate.statename.value == ''){
            document.getElementById('statenamealert').style.display = 'block';  
            document.addstate.statename.focus(); 
            return false;     
        }
        if(document.addstate.statenamear.value == ''){
            document.getElementById('statenamealertar').style.display = 'block';  
            document.addstate.statenamear.focus(); 
            return false;     
        }
    document.addstate.submit();
    return true;
    }
    ...
    function editview(id){
        ...
        $.ajax({
            ...
            success: function(response){
                /*$('#countrynameedit').val(response.countryname);
                $('#statenameedit').val(response.statename);
    ...
    function editstateValidation() {
        if(document.editstate.countrynameedit.value == ''){
            document.getElementById('countrynamealertedit').style.display = 'block';  
            document.editstate.countrynameedit.focus(); 
            return false;     
        }
        if(document.editstate.statenameedit.value == ''){
            document.getElementById('statenamealertedit').style.display = 'block';  
            document.editstate.statenameedit.focus(); 
            return false;     
        }
         if(document.editstate.statenameeditar.value == ''){
            document.getElementById('statenamealerteditar').style.display = 'block';  
            document.editstate.statenameeditar.focus(); 
            return false;     
        }
    document.editstate.submit();
    return true;
    }
    </script>
