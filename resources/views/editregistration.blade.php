...
.tooltips:hover .tooltiptext {
  ...
  opacity: 1;
                            ...
                            <div class="card-body">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <input type="date" class="form-control form-control-lg" value="{{ $customer->dob }}" name="dob" id="dob" onChange="agecal()">
   ...
   $('#age').val(age);
                  ...
                  <option value="O negative" {{ ( $customer->bloodgroup == 'O negative') ? 'selected' : '' }}>O negative</option>                          
                                    ...
                                    <div class="col-sm-4">
                                        ...
                                        <select class="form-select form-select-lg"  name="country" id="country">
                                            ...
                                            <option value="{{$country->id}}" {{ ($country->id == $customer->country) ? 'selected' : '' }}>{{$country->country_name}} </option>
                                            @endforeach
                                        </select>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 mt-3">
                                        ...
                                        <select class="form-select form-select-lg"  name="insuranceprovider" id="insuranceprovider">
                                                ...
                                                <!--<option value="{{$insurance->id}}">{{$insurance->insurance_name}} </option>-->
                                                 <option value="{{$insurance->id}}" {{ ($customer->insuranceprovider == $insurance->id) ? 'selected' : '' }}>{{$insurance->insurance_name}} </option>
                                 ...
                                 <div class="alert-danger pt-1 pb-1 px-1 py-1" id="provideralert" style="display:none ;">Please select insurance provider</div>
                                    ...
                                    <div class="col-lg-3 col-md-3 col-sm-12 mt-3">
                                        <label class="form-label">Insurance Number</label><span class="red"> *</span>
                                        <input type="text" class="form-control form-control-lg" name="insuranceno" value="{{ $customer->insuranceno }}"  id="insuranceno">
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="numberalert" style="display:none ;">Please select insurance Number</div>
                                    ...
                                    <?php 
											$date=date('Y-m-d');
										    if($customer->insuranceexpirydate < $date){ ?>
											 
											  <div class="col-lg-3 col-md-3 col-sm-12 mt-3">
                                        <label class="form-label">Expiry Date</label><span class="red"> *</span><span style="color:red"> (Document Expired)</span>
                                        <input type="date" class="form-control form-control-lg" name="insuranceexpirydate" value="{{ $customer->insuranceexpirydate }}"   id="insuranceexpirydate">
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="datealert" style="display:none ;">Please select insurance Number</div>
                                    
                                               </div>
											<?php } else{ ?>
									
                                    <div class="col-lg-3 col-md-3 col-sm-12 mt-3">
                                        <label class="form-label">Expiry Date</label><span class="red"> *</span>
                                        <input type="date" class="form-control form-control-lg" name="insuranceexpirydate" value="{{ $customer->insuranceexpirydate }}"   id="insuranceexpirydate">
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="datealert" style="display:none ;">Please select insurance Number</div>
	 ...
	 <span class="tooltiptext"><embed src="{{ url('uploads') }}/{{ $existingdocs->documentfilename }}#toolbar=0" type="application/pdf" width="200" height="auto">
</span></div></td>
	 <!--<td class="text-center">-->
	 <!----
	  <span class="btn btn-link btn-sm text-danger delete" onclick="return deletedoc('{{$existingdocs->cust_id}}','{{$existingdocs->id}}',this);">
...
<!--<i class="fa fa-trash"></i></span>-->
	...
	<!----- <span class="btn btn-link btn-sm text-danger delete"onclick="delete_documents(this)" data-id="{{$existingdocs->id}}" id="doc_delete"     data-toggle="tooltip" data-placement="top" title="" data-original-title="Delete"> 
...
<!-- PAYMENT MODAL STARTS HERE -->
    ...
    <!-- EDIT doc POPUP STARTS HERE -->
        <form class="row g-3" id="editdoc" name="editdoc"  enctype="multipart/form-data"  method="post" action="{{ route('doc-regedit-vw') }}">                             
                ...
                @csrf 
                    ...
                    <div class="modal fade" id="edit-doc-type" tabindex="-1" aria-hidden="true">
                        <div class="modal-dialog modal-dialog-scrollable">
                            ...
                            <input type="hidden" class="form-control form-control-lg" id="registr_id" name="registr_id" value="{{$registr_id}}">
                            ...
                            <button type="submit" id="edit-modal-close" class="btn btn-primary" >Save</button>
    ...
    var allowedExtensions = /(\.jpg|\.jpeg|\.png|\.gif)$/i;
            if (!allowedExtensions.exec(filePath)) {
               //alert('Invalid file type');
                ...
                document.getElementById('docattachementalert').innerHTML = 'Select the file';
                return false;
            } else {
                document.getElementById('docattachementalert').style.display = 'none'; 
            }
