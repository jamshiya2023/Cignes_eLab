                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            @if(\Session::get('success'))
                                ...
                                @endif
                            <div class="card-body">
                                <table id="tblpurchaseitemm" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th style="width:2%">#</th>
                                            <th style="width:35%">Item Name & Code</th> 
                                            <th style="width:35%">Item Name & Code(Arabic)</th> 
...
@endphp
                                    ...
                                    @foreach ($itempurchases as $purchases)
                                        ...
                                        <tr>
                                            ...
                                            <td>{{$purchases->item_name_arabic}} ({{$purchases->itemcode}}) </td>
