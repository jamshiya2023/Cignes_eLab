...
<style>
            ...
            <div class="container-fluid">
                <div class="row">
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h6 class="card-title m-0">Countries</h6><a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-sample-type">Add Country</a>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="tablecountrynew" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th style="width:3%">#</th>
                                                        <th style="width:90%">Countries</th>
                                                        <th style="width:90%">Countries(Arabic)</th>
                                                ...
                                                @foreach($countries as $key => $value)
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            ...
                                                            <a href="{{ 'block-country/'.$value->id }}"  onclick="return confirm('Do you want to block this country?')" class="btn btn-link btn-sm text-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Active" aria-label="Active">
                                                                <i class="fa fa-ban" style="color:#198754;"></i>                                                                
                                                            </a>
                                                            <?php } else { ?>
                                                                <a href="{{ 'unblock-country/'.$value->id }}" onclick="return confirm('Do you want to unblock this country?')" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Blocked" aria-label="Blocked">
                    ...
                    @endforeach
                            ...
                            <form class="row g-3" id="addcountry" name="addcountry" method="post" action="{{ route('country.add') }}">                            
                                @csrf
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="countryname" id="countryname" >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="countrynamealert" style="display:none ;">Please enter country </div>                                                
                                                    </div>                                    
                                                <!--</div> 
                                                <div class="row g-4">-->
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Country Name(Arabic) <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="countrynamear" id="countrynamear" >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="countrynamealertar" style="display:none ;">الرجاء إدخال الدولة </div>                                                
                                                    </div>                                    
                                                </div> 
                                            </div>
                                            <div class="modal-footer">
                                                <a class="btn btn-primary" onclick="addcountryValidation();">Save</a>
                            ...
                            <form class="row g-3" name="editcountry" method="post" action="{{ route('country.edit') }}">                            
                                @csrf
                                <div class="modal fade" id="edit-sample-type" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Country Name <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="countrynameedit" id="countrynameedit" >
                                                        <input type="hidden" class="form-control form-control-lg">
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="countrynamealertedit" style="display:none ;">Please enter country</div>                                                
                                                    </div>   
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Country Name(Arabic) <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="countrynameeditar" id="countrynameeditar" >
                                                        <input type="hidden" class="form-control form-control-lg">
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="countrynamealerteditar" style="display:none ;">Please enter country</div>                                                
                                                    </div>  
                                                </div>                                
                                            </div>
                                            <div class="modal-footer">
                                        <input type="hidden" class="form-control form-control-lg" id="hiddenid" name="hiddenid" >
                                                ...
                                                <a class="btn btn-primary" onclick="editcountryValidation();">Save</a>
    ...
    function addcountryValidation() {
        document.getElementById('countrynamealert').style.display = 'none';
         document.getElementById('countrynamealertar').style.display = 'none';
        ...
        if(document.addcountry.countrynamear.value == ''){
            document.getElementById('countrynamealertar').style.display = 'block';  
            document.addcountry.countrynamear.focus(); 
            return false;     
        }
    ...
    function editview(id){
        ...
        $.ajax({
            ...
            success: function(response){
                $('#countrynameedit').val(response.country_name);
                $('#countrynameeditar').val(response.country_namear);
    ...
    function editcountryValidation() {
        if(document.editcountry.countrynameedit.value == ''){
            document.getElementById('countrynamealertedit').style.display = 'block';  
            document.editcountry.countrynameedit.focus(); 
            return false;     
        }
        if(document.editcountry.countrynameeditar.value == ''){
            document.getElementById('countrynamealerteditar').style.display = 'block';  
            document.editcountry.countrynameeditar.focus(); 
            return false;     
        }
