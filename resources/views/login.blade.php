    ...
    <div class="wrapper">
        ...
        <div class="page-body auth px-xl-4 px-sm-2 px-0 py-lg-2 py-1">
            <div class="container-fluid">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 d-flex justify-content-center align-items-center">
                        <div class="card1 shadow-sm w-100 p-4 p-md-5" style="max-width: 32rem;">
                            <!-- Form -->
                            ...
                            @csrf
                                <div class="col-12 text-center mb-5">
                                    ...
                                    <span class="text-white">Free access to your dashboard.</span>
                                </div>
            ...
            ?>
                                ...
                                <div class="col-12">
                                    <div class="mb-2">
                                        <label class="form-label text-white">Email or Username</label>
