...
<div class="page-body px-xl-4 px-sm-2 px-0 py-lg-2 py-1 mt-3">
            <div class="container-fluid" style="min-height:450px;" >
                <div class="row">
                    ...
                    <div class="row g-4" >
                    <form class="row g-3" id="adduserrole" name="adduserrole" method="post" action="{{ route('user_role.add') }}">                            
                    @csrf
                    <div class="col-lg-12 col-md-12 col-sm-12" >
                        <div class="card" >
                            <div class="card-header">
                                <h6 class="card-title mb-0">Add User Role</h6>
                            </div>
                            <div class="card-body">
                                <div class="row g-4">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="userrole" id="userrole">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="userrolear" id="userrolear">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <textarea id="description" name="description" class="form-control" placeholder="A brief description of the user role"></textarea>
                                               
                                    </div>
                                    <div class="col-sm-6">
                                        <label for="description">Description (Arabic)</label>
                                        <textarea id="description_ar" name="description_ar" class="form-control" placeholder="A brief Arabic description of the user role"></textarea>
                                    </div>
    ...
    function formValidation() 
{
    ...
    if(document.adduserrole.userrole.value == ''){
        document.getElementById('departmentalert').style.display = 'block';  
        document.adduserrole.userrole.focus(); 
        return false;     
    }
    else if(document.adduserrole.userrolear.value == ''){
        document.getElementById('departmentalertar').style.display = 'block'; 
        document.adduserrole.userrolear.focus(); 
        return false;      
    }

document.adduserrole.submit();
return true;
}
...
function cancelForm() {
    ...
    document.getElementById("adduserrole").reset();
