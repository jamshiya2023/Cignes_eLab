                    ...
                    <div class="col-xl-12">
                        <div class="card">
                            ...
                            @if(\Session::get('Unitsuccess'))
                                ...
                                @endif
                            <div class="card-body">
                                <table id="masterunits" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                    <thead>
                                        <tr>
                                            <th style="width:5%">#</th>
...
@endforeach   
    ...
    <form class="row g-3" id="addunit" name="addunit" method="post" action="{{ route('master.unit') }}">                              
                @csrf
                        <div class="modal fade modelpopup" id="add-unit" tabindex="-1" aria-hidden="true" data-bs-backdrop="static" style="overflow:hidden;">
                            ...
                            <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                <div class="modal-content">
                                    ...
                                    <div class="col-sm-6 text-end">
                                        <label class="form-label">Arabic Unit Name <span class="red">*</span> </label>                                        
                                        <input  dir="rtl" type="text" class="form-control form-control-lg" name="arabicunitname" id="arabicunitname" >  
                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="unitnamealertar" style="display:none ;">Please enter unit name</div>                                              
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body custom_scroll">
                                    <div class="row g-4 ">
                                        ...
                                        <div class="col-sm-6 text-end">
                                        <label class="form-label"> Unit Name(Arabic) <span class="red">*</span></label>                                        
                                        <input  dir="rtl" type="text" class="form-control form-control-lg" name="arabicunitnameedit" id="arabicunitnameedit" >
                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="unitnameeditalertar" style="display:none ;">Please enter unit name</div>
...
<script type="text/javascript">
    ...
    document.getElementById('unitnamealert').style.display = 'none';
     document.getElementById('unitnamealertar').style.display = 'none';
     ...
     if(document.addunit.arabicunitname.value == ''){
        document.getElementById('unitnamealertar').style.display = 'block'; 
        document.addunit.arabicunitname.focus();  
        return false;
     }
...
function formeditValidation()
{
    ...
    document.getElementById('unitnameeditalertar').style.display = 'none';
     ...
     if(document.editunit.arabicunitnameedit.value == ''){
        document.getElementById('unitnameeditalertar').style.display = 'block'; 
        document.editunit.arabicunitnameedit.focus();  
        return false;
     }
