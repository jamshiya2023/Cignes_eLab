...
<style>
            ...
            <div class="container-fluid">
                <div class="row">
                    ...
                    <!--COL 8 STARTS HERE -->
                                ...
                                <div class="col-xl-12">
                                    <div class="card">
                                        <div class="card-header">
                                            <h6 class="card-title m-0">Sample Type</h6><a class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#add-sample-type">Add Sample Type</a>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <table id="sampletypenew" class="table card-table table-hover align-middle mb-0" style="width: 100%;">
                                                <thead>
                                                    <tr>
                                                        <th style="width:3%">#</th>
                                                        <th style="width:45%">Sample Type</th>
                                                        <th style="width:45%">Sample Type (Arabic)</th>
                                                ...
                                                @foreach($sampletypes as $key => $value)
                                                    <tr>
                                                        <td>{{ ++$key }}</td>
                                                        <td>{{ $value->sample_type_name }}</td>
                                                        <td>
                                                            @php if($value->sample_type_name_arabic) { $arabicname = $value->sample_type_name_arabic; } else { $arabicname = '-NA-'; } @endphp
                                                            {{ $arabicname }}
                                                        </td>
                                                        <td class="text-center">
                                                            ...
                                                            <a href="{{ 'block-sample-type/'.$value->id }}"  onclick="return confirm('Do you want to block this sample type?')" class="btn btn-link btn-sm text-info" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Active" aria-label="Active">
                                                                <i class="fa fa-ban" style="color:#198754;"></i>                                                                
                                                            </a>
                                                            <?php } else { ?>
                                                                <a href="{{ 'unblock-sample-type/'.$value->id }}" onclick="return confirm('Do you want to unblock this sample type?')" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Blocked" aria-label="Blocked">
                            ...
                            <form class="row g-3" id="addsampletype" name="addsampletype" method="post" action="{{ route('sampletype.add') }}">                            
                                @csrf
                                <div class="modal fade" id="add-sample-type" tabindex="-1" aria-hidden="true">
                                    <div class="modal-dialog modal-lg modal-dialog-scrollable">
                                        <div class="modal-content">
                                            <div class="modal-header">
                                                <h5 class="modal-title">Sample Type</h5>
                                                <button type="button" id="add-modal-close-x" class="btn-close"></button>
                                            </div>
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Sample Type Name <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="sampletypename" id="sampletypename" >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="sampletypenamealert" style="display:none ;">Please enter sample type name </div>                                                
                                                    </div> 
                                                    
                                                    <div class="col-sm-6 text-end">
                                                        <label class="form-label">Sample Type Name (Arabic) <span class="red">*</span></label>
                                                        <input type="text" dir="rtl" class="form-control form-control-lg" name="arabicsampletypename" id="arabicsampletypename" >
                                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="sampletypenamealertar" style="display:none ;">Please enter sample type name </div>                                                

                                                    </div> 
                                                </div>                                
                                            </div>
                                            <div class="modal-footer">
                                                <a class="btn btn-primary" onclick="addsampleValidation();">Save</a>
                            ...
                            <form class="row g-3" name="editsampletype" method="post" action="{{ route('sampletype.edit') }}">                            
                                @csrf
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body custom_scroll">
                                                <div class="row g-4">
                                                    <div class="col-sm-6">
                                                        <label class="form-label">Sample Type Name <span class="red">*</span></label>
                                                        <input type="text" class="form-control form-control-lg" placeholder="Enter here" name="sampletypenameedit" id="sampletypenameedit" >
                                                        <input type="hidden" class="form-control form-control-lg" name="hiddenid" id="hiddenid"  >
                                                        <div class="alert-danger pt-1 pb-1 px-1 py-1" id="sampletypenamealertedit" style="display:none ;">Please enter sample type name </div>                                                
                                                    </div>  
                                                    
                                                    <div class="col-sm-6 text-end">
                                                        <label class="form-label">Sample Type Name (Arabic)<span class="red">*</span></label>
                                                        <input type="text" dir="rtl" class="form-control form-control-lg" name="arabicsampletypenameedit" id="arabicsampletypenameedit" >
                                                    <div class="alert-danger pt-1 pb-1 px-1 py-1" id="sampletypenamealerteditar" style="display:none ;">Please enter sample type name </div>                                                

                                                    </div>
                                                </div>                                
                                            </div>
                                            <div class="modal-footer">
                                                <a class="btn btn-primary" onclick="editsampleValidation();">Save</a>
    ...
    $('#add-modal-close-x, #add-modal-close').click(function() {
        $('#sampletypename').val('');
        $('#arabicsampletypename').val('');
        $('#sampletypenamealert').hide();
        $('#add-sample-type').modal('hide');
    });

    $('#edit-modal-close-x, #edit-modal-close').click(function() {
        $('#sampletypenamealertedit').hide();
        $('#edit-sample-type').modal('hide');
    });

   
    function addsampleValidation() {
        document.getElementById('sampletypenamealert').style.display = 'none';
         document.getElementById('sampletypenamealertar').style.display = 'none';
        if(document.addsampletype.sampletypename.value == ''){
            document.getElementById('sampletypenamealert').style.display = 'block';  
            document.addsampletype.sampletypename.focus(); 
            return false;     
        }
        if(document.addsampletype.arabicsampletypename.value == ''){
            document.getElementById('sampletypenamealertar').style.display = 'block';  
            document.addsampletype.arabicsampletypename.focus(); 
            return false;     
        }
    document.addsampletype.submit();
    return true;
    }
    ...
    function editview(id){
        ...
        $.ajax({
            ...
            success: function(response){
                $('#sampletypenameedit').val(response.sample_type_name);
                $('#arabicsampletypenameedit').val(response.sample_type_name_arabic);
    ...
    function editsampleValidation() {
        if(document.editsampletype.sampletypenameedit.value == ''){
            document.getElementById('sampletypenamealertedit').style.display = 'block';  
            document.editsampletype.sampletypenameedit.focus(); 
            return false;     
        }
         if(document.editsampletype.arabicsampletypenameedit.value == ''){
            document.getElementById('sampletypenamealerteditar').style.display = 'block';  
            document.editsampletype.arabicsampletypenameedit.focus(); 
            return false;     
        }
    document.editsampletype.submit();
    return true;
    }
    </script>
