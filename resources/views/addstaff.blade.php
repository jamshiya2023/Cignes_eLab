                ...
                <div class="col-lg-12 col-md-12 col-sm-12">
                        ...
                        <div class="row">                                   
                                    <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                                        ...
                                        <select class="form-select form-select-lg" tabindex="-98" name="department" id="department">
                        ...
                        <div class="row">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                                        ...
                                        <input id="dateofbirth" name="dateofbirth" type="text" class="form-control form-control-lg">
                        ...
                        <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                                    ...
                                    <div class="col-lg-6 col-md-6 col-sm-12 mt-3">
                                        ...
                                        <input type="text" class="form-control form-control-lg" name="specialist">
                                    </div>
                        </div>
                        <div class="row">
                        ...
                        <div class="row"> 
                                    ...
                                    <input type="hidden" class="form-control form-control-lg" name="tempcustid" id="tempcustid" value = "{{ uniqid() }}">
                                        <a style="cursor:pointer;" class="btn btn-primary mt-5" onclick="documentsValidation();">Save & Add More</a>
                                    </div>
                        </div>
                        <div class="row">
                                    ...
                                    <div class="col-sm-12 mt-3">
                                        ...
                                        <textarea rows="4" class="form-control no-resize" name="details" ></textarea>
                                    </div>
                        </div>
