...
<div class="page-body px-xl-4 px-sm-2 px-0 py-lg-2 py-1 mt-3">
                        ...
                        <div class="card">
                            <div class="card-header">
                                ...
                                <div class="row col-md-12">
								  <form class="row g-3" id="searchform" name="searchform"  method="post"  action="{{('search.list') }}" >                            
                                 @csrf
								<div class="col-md-3">
                                        <label class="form-label"> Registration No </label>
                                        <input type="text" class="form-control form-control-lg" name="registration_number" id="search" value="{{$regno}}">
                                        </div>
									<div class="col-md-3">
                                        <label class="form-label"> Date  </label>
                                        <input type="date" class="form-control form-control-lg" name="date" id="search" value="{{$date}}">
                                         </div>
								<div class="col-md-3">
                                        <label class="form-label"> Customer Name </label>
                                        <input type="text" class="form-control form-control-lg" name="customer_name" id="search" value="{{$customer}}">
                                         </div>
									<div class="col-md-3">
                                        <label class="form-label"> Invoice No </label>
                                        <input type="text" class="form-control form-control-lg" name="invoice_number" id="search" value="{{$invoiceno}}">
                                         </div>
									<!--<div class="col-md-3">-->
         ...
         <!--                                 </div>-->
                                    ...
                                    <div class="col-sm-2 mt-1">
                                                    ...
                                                    <a href="{{ url('/registration.list') }}" class="btn btn-dark mt-5 text-white">Clear</a>
                                    </div>
                                    ...
                                    @foreach($CustomerDetails as $Customer)
                                        ...
                                        <tr>
											...
											<td class="text-center">
											 ...
											 <a href="{{'edit-registration/'.$Customer->id }}" class="btn btn-link btn-sm text-secondry" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Edit" aria-label="Edit">
											   ...
											   <!-- <a href="{{'delete-registration/'.$Customer->id}}" onclick="return confirm('Do you want to Delete this Registration?')" class="btn btn-link btn-sm text-danger" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-original-title="Delete" aria-label="Delete">
                                                    <i class="fa fa-trash" style="color:#d63384;"></i>
                                                </a>-->
                                                </td>
                                        </tr>
                                        @endforeach
...
$.ajaxSetup({ headers: { 'csrftoken' : '{{ csrf_token() }}' } });
            ...
            $.ajax({
                ...
                success: function(data)
                {
                   ...
                   $.each(data, function(key, value) {
                      $('#proofview').append('<div class="d-flex justify-content-between mb-3"><div class="form-check form-check-inline"><label class="form-check-label" for="flexCheckDefault"><strong>' + value.documentname + '</strong> - ' + value.documentnumber + '  <span class="text-danger d-flex large">Expired on ' + value.documentexpirydate + '</span></label></div><div><a href="{{ url("uploads") }}/'+value.documentfilename+'" class="tooltips" target="_blank">View <span class="tooltiptext"><embed src="{{ url("uploads") }}/' + value.documentfilename + '" #toolbar=0" type="application/pdf" width="120" height="auto"></span></a></div></div>');
                    });
    ...
    if(document.searchform.registration_number.value !='' || document.searchform.date.value !='' || document.searchform.customer_name.value !='' || document.searchform.invoice_number.value !='')
    {
