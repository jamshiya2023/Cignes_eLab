...
class TestCategoryController extends Controller
{
    public function testcategoryview()
    {
        if(Auth::check()){
            ...
            $testcategoryCount = TestCategory::select('id','testcategory','testcategory_arabic','status','ordering')
            ->orderBy('ordering','asc')
            ->count();
            //dd($testcategoryCount);
            return view('master_test_category', ['testcategory' => $testcategory,'testcategoryCount'=>$testcategoryCount, 'ordering' => $ordering]);
        }
